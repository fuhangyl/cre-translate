...
export default {
  ...
  InfluencerDescription:
    'Influencer Club | Earn rewards, discounts and exclusive gifts by promoting Creality Cloud on Social Media.',
  ...
  aboutUs_hello:
    'Welcome to Creality Cloud. You can contact our support team by phone or email.',
  aboutUs_intro1:
    "Creality Cloud is the world's first all-in-one 3D printing platform that offers 3D model trading, cloud slicing, remote control printers and many more features to make 3D printing easier and smarter for over a million makers.",
  aboutUs_intro2:
    'It is a platform for 3D printing creation and an ever-growing community for EVERYONE.',
  aboutUs_intro3:
    "Creality Cloud aims to become the world's largest service platform in 3D printing.",
  ...
  account_cancellation_confirm_rule3:
    'Please read and tick to agree the Terms of Account Cancellation.',
  account_cancellation_confirm_text1:
    'Before proceeding with the permanent deletion of your Creality Cloud account, please carefully read and consider the following points:',
  account_cancellation_confirm_text2:
    '1. Once your account is deleted, all content and information you have shared on Creality Cloud will be irretrievable. This includes posts, 3D models, slice files, and your printing history, among others.',
  account_cancellation_confirm_text3: '',
  account_cancellation_confirm_text4:
    '2. Deleting your account will result in the permanent clearance of your account balance. This includes credits, Cuvacoins, XP, and any purchased 3D models.',
  account_cancellation_confirm_text5:
    '3. After deleting your account, you will no longer be able to interact with other users on Creality Cloud. This includes activities such as commenting, liking, favoriting, and following.',
  account_cancellation_confirm_text6: '',
  account_cancellation_confirm_text7:
    'Please note the following conditions required for deleting your account:',
  account_cancellation_confirm_text8:
    '1. Ensure that there are no pending items associated with your account, such as unfinished CR Care+ orders or printing tasks. Please complete any pending items as prompted before applying for an account deletion.',
  account_cancellation_confirm_text9: '',
  account_cancellation_confirm_text10:
    '2. Remove your moderator status from all groups before proceeding with the account deletion.',
  account_cancellation_confirm_text11:
    'Thank you for your attention and understanding.',
  account_cancellation_confirm_text12: 'Attention,',
  account_cancellation_confirm_tip1:
    'Cancellation will delete all the content in the group and all the assets in the account. Are you sure you want to cancel the account?',
  account_cancellation_confirm_tip2:
    "Cancellation will delete all the assets in the account and it won't be able to retrieve any content or information. Are you sure you want to cancel the account?",
  account_cancellation_confirm_tip3:
    'The account cancellation application initiated by you will affect the normal use of some functions. Do you still want to cancel the account?',
  account_cancellation_confirm_tip4:
    'You have initiated account cancellation and cannot use the current function. You can use the function normally by clicking [Cancel] to cancel the account cancellation.~',
  account_cancellation_confirm_tip5:
    'Your account cancellation request has been submitted on ${date}. Please be patient. We will review your application within 10 working days.',
  account_cancellation_invalid_title1: 'Account cancellation failed.',
  account_cancellation_invalid_title2:
    'You are unable to cancel your account due to the following reasons.',
  ...
  account_cancellation_tips:
    'You have initiated account cancellation and cannot use the current function. You can use the function normally by clicking [Cancel] to cancel the account cancellation.',
  account_cancellation_verify_text:
    'For your account security, please enter the verification code that we sent to you. ',
  activity_moreModels: 'For You',
  addMake: 'Add a Make',
  addMakeBtn: 'Add a Make',
  album_author: 'Author',
  album_author_other_album: 'Other Portfolios from the Author',
  album_cancel_collection_hint:
    'Are you sure you want to unfavorite this portfolio?',
  album_cant_del:
    'Unable to delete. The portfolio is in the process of approval.',
  album_cant_edit:
    'Unable to edit. The portfolio is in the process of approval.',
  album_content: 'Content',
  album_content_add: 'Add content',
  album_content_add_hint:
    'Add your article or post to the portfolio to better manage your content.',
  ...
  album_content_inset_album_hint:
    'Categorize your content into one portfolio to better manage your content.',
  ...
  album_content_remove_confirm:
    'Are you sure you want to remove the content from this portfolio?',
  album_content_remove_hint:
    "The content won't be deleted after being removed from this portfolio. ",
  ...
  album_create_btn_hint:
    "You haven't created any portfolio for your content. Click to create.",
  album_create_cover: 'Cover',
  album_create_cover_add: 'Add Cover',
  album_create_cover_add_hint:
    'Cover image size 500x500(px) best, file size no more than 5M',
  ...
  album_delete_hint:
    'Your content will be preserved when you delete this portfolio.',
  ...
  album_status_await_hint:
    "The portfolio has been created. You haven't added any content yet.",
  ...
  allActive_addDeviceTip:
    'Please Scan the QR code  to know more about the campaign. ',
  allActive_all: 'All',
  ...
  allModde: 'All Model',
  analysis_dialog_desc:
    'Using this symbol slice may result in the following issues:',
  analysis_dialog_desc_1:
    '1. In the print interface, slicing list, or slicing details page, <em>the thumbnail, model, size,</em> and other information may not be displayed.',
  analysis_dialog_desc_2:
    '2. When using this sliced file for printing, you may experience inaccurate <em>printing status and progress display, as well as a lack of filament usage information</em>.',
  analysis_dialog_desc_3:
    '3. Printing with partially sliced files <em>may result in the inability to generate time-lapse video correctly</em>.',
  ...
  atuser_use_del_c:
    'You are not able to mention the user because you’re blocked. Do you want to remove the user from your contacts?',
  atuser_use_del_t:
    'You are not able to mention the user because you’re blocked.',
  ...
  bindEmailPayoneerTips:
    'To use Payoneer, you need to verify your identity information. Please bind your email address so that Payoneer can verify your identity and contact you.',
  ...
  bind_email_into:
    'You  can bind your email address in Personal Center>Account Settings> Security > Bind Email Address.',
  bind_email_pass: 'Skip, do not bind for now.',
  bind_email_tips:
    'If you do not bind your email address, you will not be able to acquire the latest blog news and new features from Creality Cloud.',
  bind_email_tips_new:
    'Binding an email address can enhance the security of your account. You will also receive timely notifications about activities and printing information via email.',
  ...
  blogWrap_blogReisterTitle2:
    'Sign up for the latest 3D printing news and free high-quality 3D models!',
  ...
  blogWrap_blogReisterTitle6:
    'Access our extensive 3D model library and enjoy a seamless 3D printing experience with clear and straightforward slicing steps.',
  blogWrap_comments: 'Comment',
  blogWrap_homeRemark:
    'Insightful reviews and tutorials on various aspects of 3D printing',
  ...
  brics_A1_1:
    'Whether the polygon model is aligned to the coordinates as required by the task',
  brics_A2: 'Reverse modeling requirements',
  brics_A2_1: 'A single entity or not?',
  brics_A3: 'Features of reverse modeling',
  brics_A3_1:
    'Check if P_1 in the reversed 3D model has a corresponding feature',
  brics_A3_2:
    'Check if P_2 in the reversed 3D model has a corresponding feature',
  brics_A3_3:
    'Check if P_3 in the reversed 3D model has a corresponding feature',
  brics_A3_4:
    'Check if P_4 in the reversed 3D model has a corresponding feature',
  brics_A3_5:
    'Check if P_5 in the reversed 3D model has a corresponding feature',
  brics_A3_6:
    'Check if P_6 in the reversed 3D model has a corresponding feature',
  brics_A4: 'Reverse modeling dimensions',
  brics_A4_1:
    'Check the corresponding dimensions of Q_1 in the reversed 3D model',
  brics_A4_10:
    'Check the corresponding dimensions of Q_10 in the reversed 3D model',
  brics_A4_2:
    'Check the corresponding dimensions of Q_2 in the reversed 3D model',
  brics_A4_3:
    'Check the corresponding dimensions of Q_3 in the reversed 3D model',
  brics_A4_4:
    'Check the corresponding dimensions of Q_4 in the reversed 3D model',
  brics_A4_5:
    'Check the corresponding dimensions of Q_5 in the reversed 3D model',
  brics_A4_6:
    'Check the corresponding dimensions of Q_6 in the reversed 3D model',
  brics_A4_7:
    'Check the corresponding dimensions of Q_7 in the reversed 3D model',
  brics_A4_8:
    'Check the corresponding dimensions of Q_8 in the reversed 3D model',
  brics_A4_9:
    'Check the corresponding dimensions of Q_9 in the reversed 3D model',
  brics_A5: 'Body deviation',
  brics_A5_1:
    'Check the mean value of the body deviation of the polygon model and the reversed 3D model',
  ...
  brics_Aprompt:
    '"A-jianmo.xrl" or "A-jianmo.prt" and "A-jianmo.stp" files for 3D digital inverse modeling source files. "or "A-jianmo.prt" and "A-jianmo.stp" files.',
  ...
  brics_B4_1:
    'Check if the Q_1 feature in the reversed 3D model is correctly fixed',
  brics_B4_2:
    'Check if the Q_2 feature in the reversed 3D model is correctly fixed',
  brics_B4_3:
    'Check if the Q_3 feature in the reversed 3D model is correctly fixed',
  brics_B4_4:
    'Check if the Q_4 feature in the reversed 3D model is correctly fixed',
  brics_B4_5:
    'Check if the Q_5 feature in the reversed 3D model is correctly fixed',
  brics_B5: 'Reverse modeling dimensions',
  brics_B5_1:
    'Check the corresponding dimensions of T_1 in the reversed 3D model',
  brics_B5_2: 'Check the corresponding dimensions T_2 in the reversed 3D model',
  brics_B5_3:
    'Check the corresponding dimensions of T_3 in the reversed 3D model',
  brics_B5_4:
    'Check the corresponding dimensions of T_4 in the reversed 3D model',
  brics_B5_5:
    'Check the corresponding dimensions of T_5 in the reversed 3D model',
  brics_B5_6:
    'Check the corresponding dimensions of T_6 in the reversed 3D model',
  ...
  brics_Bprompt:
    'The digital model "B-xiufu.xrl or B-xiufu.prt" and "B-xiufu.stp" files.',
  brics_C: '3D Digital Inspection',
  brics_C1: 'Coordinate alignment',
  brics_C1_1:
    'Whether the coordinates in the test report are aligned as required by the task',
  ...
  brics_C2_4:
    'Whether the 3 planes are annotated for locations where the mean point error is greater than 0.2mm',
  brics_C3: '2D comparison',
  brics_C3_1:
    'Whether 2D comparative analysis is performed at a section 27 mm from the Datum A ',
  brics_C3_2:
    'Whether Min (negative deviation) and Max (positive deviation) are correctly marked in the section',
  ...
  brics_Cprompt:
    'The test report source file "C-jiance.cxproj" and "C-jiance.pdf" file.',
  brics_D: 'Scheme Design',
  brics_D1: 'sheji_1 Engineering Drawing',
  brics_D1_1:
    'Whether the structural shape of the part is reasonably represented',
  ...
  brics_D1_4:
    'Whether the section line of part engineering drawing is cross sectional line (material: PLA)',
  brics_D1_5:
    'Whether the roughness symbol is correctly marked (obtained without removing materials)',
  brics_D2: 'sheji_2 Engineering Drawing',
  brics_D2_1:
    'Whether the structural shape between the parts is reasonably represented',
  ...
  brics_D3_1:
    'Whether the sub-assembly is a reasonable representation of the structural shape of the two-stage gear',
  brics_D3_2:
    'Whether the sub-assembly is indicated with length, width and height',
  brics_D3_3:
    'Whether the fit between parts is correctly indicated in the subassembly',
  brics_D3_4:
    'Whether the basic parameters of module, number of teeth and pressure angle are indicated on the gear parts',
  brics_D3_5:
    'Whether the gear parts are indicated with the correct form and location tolerances',
  ...
  brics_D6_1:
    'Whether the assembly and connection relationships between parts are reasonably represented',
  brics_D6_2:
    'Check assembly engineering drawings for length, width and height',
  brics_D6_3:
    'Whether the fit between "sheji_2" and " sheji_3" is correctly indicated',
  brics_D6_4:
    'Whether the fit between "sheji_3" and " sheji_1" is correctly indicated',
  brics_D6_5: 'Whether the serial number of the extraction part is complete',
  brics_D7: 'Document saving',
  brics_D7_1:
    'Whether sheji_1-sheji_6 and sheji-zzp files are saved to the MD folder',
  brics_Dprompt:
    '2D parts drawing and 2D assembly drawing scheme design source file, and export "PDF" file format. Names of parts: churning mechanism "sheji_1", rotating handle "sheji_2", secondary gear transmission structure "sheji_3", top cover "sheji_4", box "sheji_5", general assembly drawing "sheji_5". "sheji_4", the box "sheji_5", the total assembly drawing is named "sheji-zzp".',
  ...
  brics_E1_2:
    'Whether there are structural features for mounting rotary blades',
  brics_E1_3:
    'Whether the structural features of the mounted rotary blades work to attain a clamping function',
  ...
  brics_E2_4:
    'Meet the condition that two or more parts are joined to form a non-detachable and integrated structure',
  ...
  brics_E4_1:
    'Whether sheji_1, sheji_2 and sheji_3 files are saved to the ME folder',
  brics_Eprompt:
    'Three 3D digital model source files of "sheji_1", "sheji_1" and "sheji_1" as well as STP format files',
  brics_F: 'Product appearance design',
  brics_F0: 'The overall appearance of the sheji-zzp 3D model',
  brics_F0_1:
    'The overall appearance of the sheji-zzp 3D model: structurally stable, aesthetically pleasing, smooth and creative',
  ...
  brics_F3_3:
    'Whether the overall dimensions of the product meet the requirements',
  ...
  brics_F4_4:
    'The appearance gradually changes to translucence after one rotation, the internal mechanism moves correctly, and a cycle of motion is completed with a gradual change to opacity',
  brics_F4_5:
    'Whether the internal mechanism operate correctly, and its function meets the requirements',
  brics_F5: 'Document saving',
  brics_F5_1:
    'Whether sheji_4, sheji_5, sheji-zzp and fangzhen files are saved to the MF folder',
  brics_Fprompt:
    '"sheji_4", the box "sheji_5", the total assembly drawing named "sheji-zzp" 3D digital model file and AVI format animation.',
  ...
  brics_errorTip2:
    'Fail to submit! The submission entry for this competition module is closed.',
  brics_errorTip3: 'Fail to submit! The competition has not yet started.',
  brics_examDesc:
    'By clicking "Start", you’re required to submit your works or designs for each module within a limited time. If there is no submission for a competition module, it is deemed waived for the competition module.',
  ...
  brics_noSignTip:
    'You cannot submit your work without registration for the competition. Please contact +86 13509050252 for more registration information.',
  brics_noSignTip2: 'Or you can check out our ',
  brics_noSignTip3: ' to find more opportunities.',
  brics_noSubDataTip:
    "You didn't submit your work for this competition module.",
  brics_nologinsubTip:
    'Please login to see the submission deadline for each step.',
  brics_notScored: 'No scores.',
  brics_score: '',
  brics_scoreDialogTitle: '',
  brics_scoreDialogTitleN: 'Scores for ',
  brics_stepTip:
    'Please finish and submit your work before the deadline for each step.',
  brics_subEndTip:
    "The submission entry is closed on 2nd, November. You haven't submitted any designs yet. Thank you for your attention!",
  brics_submitBtn: 'Submit',
  brics_submitDesc:
    'The following materials will be reviewed by the judges and will not be shown in public. Please submit your designs within ',
  ...
  brics_submitRemark1:
    'Please finish and submit your work for other competition modules on ',
  brics_submitRemark2: '.',
  brics_submitTime: 'Submission time',
  brics_submitTip:
    'Once the design is submitted, it cannot be modified. Please confirm that all information is correct before submitting. ',
  ...
  brics_videoFail2:
    'Upload failed, video encoding error, please submit H264 standard MP4 file',
  ...
  buyedTips:
    'The model is permanently valid after purchase, and the deletion of the model by the original author does not affect it',
  cancel: 'Cancel',
  ...
  care_asApply_detailPlaceholder:
    'To help quickly diagnose the issue, please describe it as detailed as possible. Please do not enter personal, private, or financial information, such as credit card numbers or passwords.',
  ...
  care_asApply_problem:
    'Did you manage to print something before the issue occur?',
  ...
  care_asApply_submitErrorTip:
    'Please make sure to fill in all the information before submiting it. Thank you.',
  care_asApply_submitTip:
    'We will get back to you as soon as we can. Thank you for your support!',
  ...
  care_banner_desc:
    'Enjoy peace of mind when you buy CR Care+ for selected Creality 3D printers. Accidental damage protection, priority technical support, free parts & shipping and more.',
  ...
  care_careHome_detailMatter2:
    'One time free-of-charge service provided after the purchase.',
  care_careHome_detailMatter3:
    'Please read the details <a class="terms" id="terms">< Terms ></a> before any purchase.',
  ...
  care_careHome_findSnDialogContent:
    "SN Code is the serial number of a 3D printer. Here's how to find the SN Code of your printer:",
  care_careHome_findSnMethod:
    'Get the SN number of the product by looking at the back sticker of the 3D printer.',
  care_careHome_finishPayTip: 'Payment complete. Do not submit again.',
  care_careHome_haveBought:
    'The SN Code you entered is linked with a CR Care+ plan.',
  care_careHome_modelDifferent:
    'The SN Code you entered does not match your chosen product.',
  ...
  care_careHome_notFoundSn:
    'The SN Code you entered is not eligible for purchasing CR Care+ plan.',
  care_careHome_notPayUrl:
    "There's an issue with your order. Please try again.",
  care_careHome_offTip: 'Currently Unavailable',
  care_careHome_orderInvalid:
    'The order has been invalid, please re-initiate an order',
  care_careHome_orderNo: 'Order Number',
  care_careHome_orderNumberTitle: 'Purchase Order Number',
  care_careHome_orderUnpaid:
    'You have one unpaid order. Please check it first.',
  ...
  care_careHome_payResultTip:
    'You will be redirected to the Paypal website. Please do not close this window before your payment is completed.',
  ...
  care_careHome_purchaseTip:
    'Please ensure to enter the date that appear on your proof of purchase. You cannot change it later.',
  ...
  care_careHome_watchCountry:
    'Currently, the CR Care+ plan is only available to be purchased from the following countries and regions.',
  ...
  care_faqs_a11:
    "No, it isn't. The printer owner can be changed but the SN of the printer bound to the service agreement cannot.",
  care_faqs_a12:
    'Yes. The printer owner can be changed but the SN of the printer bound to the service agreement cannot. Creality will not take responsibility for any disputes due to the transfer.',
  care_faqs_a13:
    'Please provide your printer  SN to us. This can be used to verify whether your printer is protected under CR Care+. If the damage is within service coverage, you can get free CR Care + serivce.',
  care_faqs_a14:
    'No, at the moment, CR Care+ only works within one coverage region.',
  care_faqs_a15:
    'If you request to replace the product after purchase, please remind presales or aftersales staff that you have purchased CR Care+. Creality support will instruct you on how to rebind. You will need send an email to protection@creality.com. It will take about two business days to rebind.',
  care_faqs_a16:
    '1. CR Care+ cannot be cancelled  after the purchase.<br/> 2. CR Care+ cannot be transferred to other printers after purchase.',
  care_faqs_a17:
    "This plan does not cover:<br/>1. Lost or partially lost printer and accessories.<br/>2. Stolen or abandoned printer and accessories.<br/>3. Damage caused by unsuitable use conditions.<br/>4. Any repair resulting from or following water damage.<br/>5. Deliberate losses.<br/>6. Abrasions of  profile and rail damage that do not affect the performance of the printer.<br/>7. Direct or indirect losses caused by force majeure.<br/>8. Repair requests for damage incurred outside the period of validity.<br/>9. Indirect loss and/or anticipated profit in any form.<br/>10. Extra fees resulting from technical enhancements or performance improvements.<br/>11. Personal injury and/or property loss to the customer or any other people caused by the printer.<br/>12. Any legal fees related to CR Care+'s coverage.",
  care_faqs_a2:
    'You can purchase CR Care+ from creallitycloud.com now and will be available in the Official Creality Online Store. Simply follow the onscreen instructions in the online order process. For your convenience, CR Care+ Activation Codes will be available to be purchased from your local dealer or authorized retailers in future. Not all dealers and retailers are providing  CR Care+ Activation Codes at this time.',
  care_faqs_a3:
    'No. CR Care+ is bound to the SN of your printer, meaning repair costs will automatically be deducted from your CR Care+ coverage amount. No additional payment is required.',
  care_faqs_a4:
    'If printer is within Factory Guarantee, repair costs will be paid by Creality without deduction from the CR Care+ coverage amount.',
  care_faqs_a5:
    'CR Care+ is valid immediately after purchase when bought separately.',
  care_faqs_a6:
    'Currently, CR Care+ is only available to U.S., E.U. countries, U.K. and will launch in more countries and regions in the future.',
  care_faqs_a7:
    'Product warranty is the service provided by the manufacture when product quality problems occur. While CR Care+ is a service that provides you with peace of mind, covering damage during normal use. If the unexpected happens.<br/>Although you can still enjoy standard product warranty without buying CR Care+, that can greatly reduce repair costs. Furthermore, if the repair costs are covered by a standard product warranty, the remaining balance on your CR Care+ will not be affected.',
  ...
  care_faqs_q11:
    'Is the CR Care+  bound to the original aircraft owner who purchased the plan?',
  care_faqs_q12:
    'I have transferred my printer to someone else. Can I also transfer CR Care+?',
  care_faqs_q13:
    'I have lost my electronic service agreement so I do not know the Agreement. How do I get CR Care+ service?',
  care_faqs_q14: 'Does CR Care+ support international coverage?',
  care_faqs_q15:
    'The product I purchased was replaced. Will CR Care+ I purchased become invalid? Or will plan  be re-calculated?',
  ...
  care_faqs_q3:
    'If I have purchased CR Care+, do I still need to pay for a repair?',
  care_faqs_q4:
    'If my printer is within the Factory Guarantee, will repairs be counted toward my CR Care+ coverage?',
  care_faqs_q5: 'How long after purchase does CR Care+ becom valid?',
  care_faqs_q6:
    'Is CR Care+ available to purchase from all countries and regions?',
  care_faqs_q7:
    'What is the difference between CR Care+ and Creality warranty?',
  ...
  care_myOrders_applyTip:
    'You have a service in progress. Please process it first.',
  ...
  care_myOrders_cancelConten:
    "Please bear in mind: once it's cancel, it's gone for good.",
  ...
  care_myOrders_deleteContent:
    "Please bear in mind: once it's deleted, it's gone for good.",
  care_myOrders_deleteOkBtn: 'Delete',
  care_myOrders_deleteTip: 'Delete Your Order',
  care_myOrders_deleteTitle: 'Delete',
  care_myOrders_descInfo:
    'Provides one time free parts replacement in one whole year for you without any worry about dropping, personal modify caused by operation error or other accidents.',
  care_myOrders_descInfo1: '1. CR Care+ is valid for one year.',
  care_myOrders_descInfo2:
    '2. One time free-of-charge service  provided after the purchase.',
  care_myOrders_descInfo3:
    '3. Creality Care and the corresponding product must be purchased from the same country or region.',
  care_myOrders_descInfo4:
    '4. Contact us via email: protection@creality.com. or live chat available for your later.',
  ...
  care_product_desc1:
    " CR Care+ can be bought within or outside the printer's original warranty period.",
  ...
  care_terms_a1:
    'During CR Care+ period of validity, if damage occurs accidentally under normal use, the repair parts and related costs incurred will be undertaken by Creality according to this agreement, as follows: <br/>1. For damage to screen, mainboard, fan or hot bed due to dropping, personal modify caused by operator error or other accidents, Creality will offer free repair parts to customers if service request  is sent to us within the period of validity. <br/>2. CR Care+ is only available in the country or region you selected when purchasing it on Creality App.',
  care_terms_a2:
    "This plan does not cover:<br/>1. Lost or partially lost printer and accessories.<br/>2. Stolen or abandoned printer and accessories.<br/>3. Damage caused by unsuitable use conditions.<br/>4. Any repair resulting from or following water damage.<br/>5. Deliberate losses.<br/>6. Abrasions of  profile and rail damage that do not affect the performance of the printer.<br/>7. Direct or indirect losses caused by force majeure.<br/>8. Repair requests for damage incurred outside the period of validity.<br/>9. Indirect loss and/or anticipated profit in any form.<br/>10. Extra fees resulting from technical enhancements or performance improvements.<br/>11. Personal injury and/or property loss to the customer or any other people caused by the printer.<br/>12. Any legal fees related to CR Care+'s coverage.",
  care_terms_a3:
    'The coverage amount is one time free-of-charge service  provided after the purchase. After one-time use of the CR Care+, the coverage amount is exhausedted, namely the  amount noted in the Service Agreement sent to you.',
  care_terms_a4:
    'CR Care+ is valid for one year. If you buy CR Care + separately (i.e. after purchasing the printer), the period of validity begins from the date of purchase. Please refer to the period of validity noted on CR Care + Service Agreement for details.',
  care_terms_a5:
  ...
  cart_collect_invalid_t:
    'Unable to move to the Favorite. The model item has expired.',
  cart_collection_fail_tip:
    'Unable to move to the Favorite. ${val} model items have expired.',
  cart_count_invalid:
    'Your shopping cart is full. Please purchase or remove your items in your shopping cart.',
  cart_coupon: 'Coupon',
  ...
  cart_table_check_model_collet_tip_more2:
    ' model to the Favorite? | models to the Favorite?',
  ...
  cart_table_check_model_del_tip_more1:
    'Are you sure you want to delete the selected ',
  cart_table_check_model_del_tip_more2: ' model | models?',
  cart_table_check_tips:
    'Models are digital products and cannot be refunded. If the file is missing, please contact customer service.',
  ...
  clusterPrint_addSliceErrTips:
    'There is no matching device to print the sliced file. Please add a device and then choose the file again',
  ...
  clusterPrint_createErrMes:
    'The printer size does not match the minimum printing size of the selected files',
  clusterPrint_createErrMes1:
    'Fail to get the printer information on its type and size',
  clusterPrint_createErrMes2:
    'Fail to print! The slice file size does not match the selected printer size',
  ...
  clusterPrint_deviceUsed2:
    ' print job. Please try again later after the print job is finished',
  clusterPrint_deviceX: 'Width',
  clusterPrint_deviceY: 'Length',
  clusterPrint_deviceZ: 'Height',
  clusterPrint_differentSliceTips:
    'Note: There are sliced files that cannot be printed because they do not match the printer you selected. Try switching to "System Auto-Matching" to find a matching printer',
  clusterPrint_differentSliceTips1:
    'There is no matching device to print the sliced file. The sliced file will be automatically filtered after the print job is created',
  clusterPrint_differentSliceTips2:
    'There is no matching device to print the sliced file. The sliced file will be automatically filtered after the print job is created',
  clusterPrint_dlpConsumableUse: 'Resin',
  clusterPrint_dlpConsumableUse2: 'Filament Used (Resin)',
  clusterPrint_dlpPrintTime: 'Resin',
  clusterPrint_dlpRuleTip:
    'Sliced files for Resin print are strictly matched with the device type',
  ...
  clusterPrint_editSliceInfoTips:
  ...
  clusterPrint_endTaskTips:
    'Are you sure you want to terminate all  [waiting, printing] of print jobs for',
  ...
  clusterPrint_noDeviceInfo:
    'Fail to get the printer information on its type and size',
  clusterPrint_noDeviceInfoDialog:
    'Fail to get the printer information on its type and size. Please complete the information before printing.',
  clusterPrint_noDeviceTip1:
    'There is no matching device to print the sliced file',
  ...
  clusterPrint_removeDeviceFromTaskTips2:
    'from the current print job? Please note that the printer will not perform this print job',
  clusterPrint_removeDeviceTips1:
  ...
  clusterPrint_sliceNoDevice:
    'There is no device to print this sliced file. Please add the corresponding device, or terminate this print job',
  ...
  clusterPrint_sliceSizeDevice:
    'The range of the slice file size exceeds the printer size',
  clusterPrint_stopSliceTips:
    'Are you sure you want to terminate all  [waiting] of print jobs for',
  ...
  clusterPrint_taskRuleDesc1:
    'By choosing Strictly Matching, the printer model for the slicing files must match the machine model, or it will fail to print',
  clusterPrint_taskRuleDesc2:
    'By choosing System Automatically Matching, the system will prioritize matching the printer model for slicing files with the printer model for printing. If not matched, the system will match again according to the size of the slice file',
  clusterPrint_taskRuleDesc3:
    'By choosing Specify A Printer to print, you can specify a default printer for the sliced files',
  ...
  collection_ImportCompleteTips:
    'Your model has been successfully imported and will be shown on the Model Collection page after it is reviewed.',
  collection_Imported: 'Imported',
  collection_ImportedTips:
    'The model has been imported to the current Collection page.',
  ...
  collection_created_tips:
    "You haven't created a collection yet. Create one to sort out your models.",
  collection_d1: 'Explore ',
  collection_d2:
    ', a diverse collection of meticulously crafted 3D printable models on Creality Cloud',
  collection_k: '',
  collection_del: 'Delete',
  collection_del_last_model:
    'Please note that if you delete the last model of the collection, the collection will be unavailable for other users to see and search.',
  collection_del_msg:
    "The models won't be deleted from your account after the model collection is deleted.",
  collection_del_title: 'Are you sure you want to delete the model collection?',
  collection_desc: 'Description',
  collection_desc_placeholder:
    'A detailed description may help people know more about your model collection.',
  collection_down_add:
    'No models in this collection. Please add models to make this collection',
  collection_down_del:
    'The collection is unavailable. You can delete the collection and create it again.',
  ...
  collection_example_app_text:
    ' The size of the App-banner is 750x620 pixels. It may be obscured due to some displaying adaptation reasons in the red area. <span> So we recommended displaying text or topic content in non-red areas. </span>',
  collection_example_close_text:
    'Please do not display the text or body content of the collection in this area. ',
  collection_example_web_text:
    'The size of the Web-banner is 2560x600 pixels. It may be obscured due to some displaying adaptation reasons in the red area. <span> So we recommended displaying text or topic content in non-red areas.</span>',
  ...
  collection_list_picture_up:
    'Please upload a cover image for your collection.',
  collection_maxImportNums: 'Up to 100 models can be selected.',
  collection_model: '3D Models',
  collection_modelD: '',
  collection_model_add1: 'Add Model',
  collection_model_add_tips:
    'Please <span> add at least 8 public models </span> to the model collection.',
  collection_model_up_text:
    'The number of your public models is <span> less than 8.</span> Please upload more <span> public models </span> before you create a model collection.',
  ...
  collection_no_aunt:
    'Sorry! it seems that you do not currently have the necessary permissions to create a model collection. Please contact our customer service.',
  collection_no_model: 'No models',
  collection_no_model1:
    'Please add at least 8 public models to make this collection available for the public.',
  collection_privateModelTips:
    'Please expose your model to the public before importing it into the Model Collection.',
  collection_privateModelTips1:
    'Please expose your model to the public before importing it',
  collection_push: 'Publish',
  collection_remove_btn: 'Remove',
  collection_remove_from: 'Remove from Model Collection',
  collection_remove_msg:
    "The model won't be deleted from your account after it is removed from the model collection.",
  collection_remove_title:
    'Are you sure you want to remove this mode from the model collection?',
  ...
  com_activity_activityListDesc:
    'Check out the contests held by Creality Cloud. Take a challenge and win big prizes!',
  com_activity_activityListTitle: 'Creality Cloud Campaign & Contest',
  com_activity_activityModelerErrMsg:
    'The contest is limited to verified designers only~',
  com_activity_activityOneErrMsg: "You've joined the contest",
  com_activity_activityUserErrMsg:
    'The contest is limited to qualifying users only~',
  com_activity_activityWorksErrMsg:
    'The  type of the 3D design you summitted is not qulify for the contest',
  ...
  com_activity_vipTipsMsg:
    'This contest is only for Premium members. Check [Contest Rules ] for more details',
  ...
  com_activity_worksEmpty3:
    "The contest has ended. You haven't submitted any 3D designs yet~",
  com_activity_worksTips:
    'Your design will be shown on this contest page after approval',
  ...
  commonDialog_downloadTip:
    'Communicate together with more 3D printing lovers.',
  ...
  common_hours: 'Hour',
  common_ieTip:
    'The browser version you are using is too low, you will not be able to browse and use this website normally, it is suggested to change the browser, thank you!',
  common_minutes: 'Min',
  common_model: 'model',
  common_seconds: 'Sec',
  ...
  community_group_d:
    'In the Creality Cloud user group, you will find all new updates, discussions, feedback about the app, and 3D printing.',
  ...
  coupon_application_page_btn_fail:
    'Application failed. Please upload paid 3D models and set them as public.',
  coupon_application_page_btn_succ: 'Successful Application',
  coupon_application_page_btn_succ2:
    'Thank you for your participation. If your 3D model is selected for the promotion, we will send you a system message.',
  coupon_application_tick_agree:
    'Please tick to agree to Creality Cloud Coupon Service Agreement.',
  coupon_applied_agree1: 'I have read and agree to',
  coupon_applied_agree2: 'Creality Cloud Coupon Service Agreement',
  coupon_applied_desc:
    'Boost your 3D model sales and exposure - join our coupon promotion today!',
  ...
  coupon_get_empty_tips:
    'Fail to get the coupon. There are no eligible coupons. ',
  coupon_get_now_btn: 'Get',
  coupon_get_one_empty_tips:
    'Fail to get the coupon. The number of the coupon has exceeded the limit.',
  ...
  coupon_pay_succ_text1:
    'Click on "View Model" to see the model you purchased on Model> My Purchased.',
  coupon_pay_succ_text_use_1:
    'Thank you for your support and recognition for [',
  coupon_pay_succ_text_use_2:
    ']. Click on "View Model" to see the model you purchased on Model> My Purchased.',
  ...
  creat_model_upload_certificate_text2:
    'Upload a proof or certificate of your copyright and help us to provide a well-developed general framework for the protection of creative designs. We accept all kinds of copyright certificates in different countries as long as it is under the applicable law. We will review the authenticity and validity of the copyright certificate you upload. Any fraud will be dealt with strictly. ',
  creat_model_upload_certificate_tip1:
    'Upload a proof or certificate of your work to prove copyright.',
  creat_model_upload_certificate_zs: ' photos',
  creat_model_upload_rules_text:
    'I hereby declare that all digital 3D files uploaded are my/my team’s original work. The 3D design uploaded does not contain any published or stolen designs of any other person or a group. I completely own the rights to this design, and there is no copyright infringement intended. I am fully aware that I shall be responsible for any legal consequences of this statement.',
  creat_model_upload_rules_text_s:
    'I hereby declare that all digital 3D files uploaded strictly follow the Creative Commons license. The remixed model upload is under the permission of the original designer and its contribution is given to the original designer. I am fully aware that I shall be responsible for any damages and compensation resulting from such copyright infringement, including any claims by the designer or a third party.',
  ...
  createGroup_descPlaceholder:
    'Add a description, it will be seen by more people...',
  ...
  createPost_addTagTips:
    'Add tags to your article that reflect the content theme, ',
  ...
  createPost_contentMinTextTip:
    'The text should not be less than 10 characters.',
  ...
  createPost_enterTextTip1:
    'To increase the popularity of your post, please add ',
  ...
  createPost_selectGroupTip:
    'Choose a group to share your work with kindred spirits.',
  createPost_setParams: 'Set Params',
  createPost_setParamsTip:
    'Share your printing preferences to help other makers',
  ...
  createPost_titleMinTextTip:
    'The title should not be less than 10 characters.',
  createPost_unfollow: 'Unfollow',
  createPost_uploadTip:
    'upload images or videos to get your post more popular.',
  ...
  designer_faq_desc1:
    "<p>• The model must be of high quality and high precision. Models that were created quickly with 3d modeling tools are not counted for rewards.</p>\n  <p>• You must be the original designer of the 3D model you uploaded. Infringing models will not be given any rewards and will be removed from the platform to protect the designer's original copyright. </p>\n  <p>• Paid and free 3D models are all counted for rewards. Each model upload will only count once toward the reward. Duplicate models won't count toward the rewards.</p>\n  <p>• You need to upload attachment files for your model print settings, slice settings, assembly instructions, etc.</p>",
  designer_faq_desc2:
    'You are not allowed to delete the 3D models which were participated in the rewards. If the model is deleted, Creality Cloud has the right to restore the model on the platform.',
  designer_faq_desc3:
  ...
  designer_faq_desc4:
    'Log in to your Creality Cloud account and go to Personal Center > My Statistics to view your sales achievement. All statistics and payments are calculated on a calendar monthly basis.',
  designer_faq_desc5:
    'The Designer New Support Program will end on December 31, 2023. In case of fraud and cheating behavior on the sales order, Creality Cloud has the right to refuse to issue rewards.',
  ...
  device_connectionFailedMsg1:
    'Connection failed. Please check if the device connection is normal.',
  device_device: 'Devices',
  device_deviceMismatchMsg:
    "The gcode file doesn't match this device. Choose another device to print?",
  device_deviceTypeMismatch: 'Device type mismatch',
  device_enter: 'Enter',
  device_hotBedTemperature: 'Hot bed temperature',
  device_inProgressMsg:
    'The device is doing processing. Please try again later.',
  device_noDevice:
    'There is no device information, please move to the mobile end to add device!',
  ...
  device_print_ai_bind_email3:
    'address to receive timely notifications via email. This will allow us to keep you informed about important updates.',
  device_print_ai_bind_email_title:
    'Once you have bound your email address, you can be notified via email if any issues arise during the printing process. We will promptly address and assist you with the problem.',
  ...
  device_self_check_err_msg1:
    'Nozzle heating abnormality, please refer to the printer manual for inspection.',
  device_self_check_err_msg2:
    'Bed heating abnormality, please refer to the printer manual for inspection.',
  device_self_check_err_msg3:
    'Nozzle cleaning abnormality, please refer to the printer manual for inspection.',
  device_self_check_err_msg4:
    'Z-axis compensation abnormality, please refer to the printer manual for inspection.',
  device_self_check_err_msg5:
    'Auto bed leveling abnormality, please refer to the printer manual for inspection.',
  ...
  down_app_d:
    'Get download free Creality Cloud - All-in-One 3D Printing Platform on your iOS and Android Phone.',
  down_app_k: 'Download Creality Cloud, Creality Cloud Download center',
  down_app_page_text_1:
    'A diverse, convenient and interesting all-in-one 3D printing platform',
  down_app_page_text_10:
  ...
  down_app_page_text_19:
    'Follow and stay in touch with millions of 3D printing hobbyists.',
  down_app_page_text_2:
    "Creality Cloud is the world's first integrated 3D printing platform, with model sharing/trading, cloud slicing/slicing software, remote control printing, remote video monitoring, personalized creative modeling tools and other core gameplay, it is also an interactive social exchange for all 3D printing enthusiasts.",
  down_app_page_text_20:
    'Share content and get advice or solutions on 3D printing to improve your skills.',
  down_app_page_text_21:
  ...
  down_app_page_text_4:
    'Discover thousands of 3D printable models anytime and anywhere in this pocket model library. Earn an income from your original 3D designs.',
  down_app_page_text_5:
    'Earn an income from your original 3D designs and get more exposure from official promotions.',
  down_app_page_text_6:
  ...
  downloadApp:
    'Join the lucky draw campaign in the Creality Cloud app Me> Lucky Draw.',
  ...
  editUser_errNickName:
    'Nicknames can only contain letters, Chinese, numbers, underscores and underscores!',
  ...
  exitGroup_content:
    'Are you sure to quit? If you exit, you will no longer receive updates from the group',
  ...
  feature_desc1:
    'Get access to unlimited high-quality STL files from talented 3D creators, ready for your printing pleasure.',
  feature_desc2:
    'Transform your pictures into stunning lithophanes and create 3D models with your own ideas.',
  feature_desc3:
    'Take the plunge into personalized slicer settings and slice through multiple models in a breeze.',
  feature_desc4:
    'Remotely manage up to 20 printers from anywhere with our intuitive dashboard, effortlessly distribute print jobs, and generate detailed reports for a smooth and efficient printing process.',
  feature_desc5:
    'Capture the entire printing process with a mesmerizing time-lapse video, safely stored in the cloud and ready to be shared with your friends and family!',
  feature_desc6:
    'Keep a close eye on your printing progress in real-time, and receive timely notifications or even automatic pause/stop print if any irregularities are detected.',
  ...
  feedback_deviceFeedBackTip:
    'To assist you more effectively in resolving any device-related issues, kindly select the relevant device from the options provided. This will enable us to accurately locate and provide a suitable solution for your specific device.',
  ...
  fileManage_t:
    '[Official] Download Creality Firmware and Software | Creality Cloud',
  fileManage_d:
    'Here you can download Creality slicers, Creality firmware, and Creality software for your Creality 3D printers.',
  fileManage_k:
    'creality slicer, creality cloud, creality firmware, creality software, creality slicer download, creality download, creality print software, creality 3d printer software, creality firmware download',
  fileManage_software_t: ' - 3D printing software of Creality Cloud',
  fileManage_software_d:
    'Here you will find an overview of the Creality slicing software for FDM and Resin.',
  fileManage_software_k:
    ', 3D printing software, Creality slicing software, FDM slicing software',
  fileManage_plugins_t: ' - Open Source Plugins of Creality Cloud',
  fileManage_plugins_d:
    'With Creality Cloud Cura Integration, you can slice STL files in Cura and upload G-code files to Creality Cloud to remote print your 3D models. And Creality Cloud integration for OctoPrint is a plugin used for connecting your 3D printers to the Creality Cloud app.',
  fileManage_plugins_k: ', Open Source Plugins',
  fileManage_firmware_t: ' - Creality Cloud Firmware for 3D Printing',
  fileManage_firmware_d:
    'All Creality firmware is in here. Get download the ultimate firmware to update your 3D printers.',
  fileManage_firmware_k: ', creality cloud firmware, creailty firmware',
  fileManage_box_t:
    ' - CrealityBox and CrealityPi - Creality Cloud Terminal Firmware',
  fileManage_box_d:
    'With CrealityBox you can slicing and printing with the Creality Cloud app. And CrealityPi is one of the Raspberry Pi Imager customized on the basis of OctoPrint. With CrealityPi, you can remote control and monitor your 3D printer.',
  fileManage_box_k: ', Creality Cloud Terminal Firmware',
  fileManage_other_t:
    ' - Other 3D printer software and firmware - Creality Cloud',
  fileManage_other_d:
    'Find other 3D printer software and firmware on Creality Cloud.',
  ...
  fileManage_crealityDecript1:
    'Discover thousands of 3D printable models anytime and anywhere in this pocket model library. Earn an income from your original 3D designs.',
  fileManage_crealityDecript2:
    'Powerful in-app slicer allows you to slice multiple 3D models at one time to help you save more time.',
  fileManage_crealityDecript3:
    'Remotely control your 3D printer with advanced print settings whenever and wherever with Creality Cloud App on your phone.',
  fileManage_crealityDecript4:
    'World players gather together. Share content and get advice or solutions on 3D printing to improve your skills!',
  fileManage_crealityDecript5:
    'Remotely control your 3D printer whenever and wherever with Creality Cloud App on your phone.',
  fileManage_crealityDescript:
    "Creality Cloud is the world's first all-in-one 3D printing platform that offers 3D model trading, cloud slicing, remote control printers and many more features.",
  ...
  fileManage_cura2Title1:
    'Click the following link to download the Creality Cloud plugin.',
  fileManage_cura2Title2:
    'Install and launch Ultimaker Cura, drag and drop the Creality Cloud plugin package in Cura.',
  fileManage_cura2Title3:
    'Click on "OK" and restart Cura. The plugin will be installed after restarting.',
  fileManage_cura2Title4:
    'Running Cura again, navigate to "Extensions" at the top menu. You can find "Creality Integration" on the list when the plugin is successfully installed.',
  fileManage_cura2Title5:
    'Navigate to Extensions> Creality Integration>Settings, then choose a server for connecting the Creality Cloud plugin.',
  ...
  fileManage_curaTitle1:
    'Click "Marketplace" on the right side of the top inside Cura.',
  fileManage_curaTitle2:
    'Click "Plugins" and select "Creality Cloud Integration" to install.',
  fileManage_curaTitle3:
    'Click "Installed" to confirm the "Creality Cloud Integration" installation.',
  ...
  fileManage_firmwareTips:
    'To update, first check your printer, board, and firmware versions. Next, pick the right update file for download. Only then start the update.',
  ...
  fileManage_octoprintTips1:
    'Please download and install Raspberry Pi Imager on your computer before installing the Raspberry Pi firmware. ',
  fileManage_octoprintTips2: 'Click to download.',
  fileManage_octoprintTitle0:
    'Enter the following Raspberry Pi terminal commands:',
  ...
  fileManage_octoprintTitle1:
    'Make sure you have installed OctoPrint on Raspberry Pi and navigate to the Plugin Manager page.',
  fileManage_octoprintTitle2:
    'Install plug-ins via the bundled Plugin Manager on Octoprint.',
  fileManage_octoprintTitle3:
    'Enter the Octoprint setting page to activate the Creality Cloud plugin.',
  ...
  fileManage_versionTitle2:
    ' or above of the firmware version supports OTA upgrade',
  fileManage_viewMore: 'Show all',
  folder_add_btn: 'Add',
  folder_add_suc_msg:
    'Successfully added! You can now view and manage the models in the [',
  ...
  folder_create_tips:
    'You can add models to the model folder by using "Add to Folder".',
  folder_del_msg:
    'Are you sure you want to delete this folder? Deleting the folder will not delete the model files within it. The files will still be displayed in the "My Uploads" list.',
  folder_del_tip: 'Delete folder',
  folder_editor_text: 'Editor folder',
  folder_name_no:
    'The folder currently has no models. Go ahead and add some now!',
  ...
  footer_address:
    'Unit 1307, Beverley Commercial Centre, 87-105 Chatham Road South, Tsim Sha Tsui, KLN',
  footer_beian: '',
  ...
  footer_text:
    'Copyright © 2023 Shenzhen Creality 3D Technology Co., Ltd All Rights Reserved.',
  footer_text1:
  ...
  game_isNoVote:
    'The chance to vote has run out! Forwarding can help contestants canvass',
  game_ismyPost:
    "You can't vote for your own work! Click share to invite friends to vote for you",
  ...
  game_modelUploadTip:
    'The model file only supports stl, and multiple files are recommended to be uploaded in the form of a compressed package',
  ...
  game_subTitle:
    'The following materials will be reviewed by the judges and will not be publicly displayed',
  ...
  game_submitTip:
    '参赛作品仅有一次提交机会，提交后无法修改，请您检查无误后再点击确认',
  game_submitTitle: 'Submit Your Designs',
  game_submitted:
    "You've submitted your designs. Please don't submit it again.",
  game_submittedTip:
    'If you have any questions, please feel free to contact us at teamcloud@creality.com.',
  game_success: 'Successful',
  game_tip: 'Tip',
  game_tipValue:
    'If you have other questions, please contact teamcloud@creality.com',
  ...
  game_videoInputPla:
    'An interesting title is more likely to attract attention...',
  game_videoListFirst: 'Public display',
  game_videoPlaceholder:
    'Format MP4, duration ≤2min, recommended size 720px*576px/1024px*576px',
  game_videoTip:
    'Drag and drop to sort the videos, the first video work will be displayed',
  ...
  gcodeDetail_exceedMax:
    'To ensure the preview effect, the preview is not supported for files over 50MB at the moment.',
  ...
  gcode_down: 'Download',
  gcode_emptyCreationMsg:
    'There are no slice files at the moment. Go to slice some G-code files now!',
  gcode_more: 'More',
  ...
  gcode_version:
    'Please download the Creality Cloud app V4.11.0 or above to explore the feature.',
  ...
  giftPackage_fail:
    'Sorry! You are not eligible for this campaign. Please see the campaign rules for more details.',
  ...
  giftPackage_userCenter:
    'You can check your premium membership in Personal Center and simply find these models in Models>My Purchased.',
  gift_package_bind_email_title:
    'If you do not bind an email address, you may not receive timely updates on the latest logistics information for your Gift Shop orders.',
  got_medal_tip1: '',
  ...
  head_nav_software_des_1:
    'The powerful Creality Cloud offers an even more superior and comprehensive experience on the mobile app platform.',
  head_nav_software_des_2:
    "Get Creality's self-developed slicing software to easily slice and export slicing files to Creality Cloud for printing.",
  head_nav_software_des_3:
    'Discover the most up-to-date firmware for your Ender, Resin, CR, and Sermoon series 3D printers from Creality.',
  head_nav_software_des_4:
    "Experience the power of Creality's Open Source Plugins, enabling you to effortlessly slice STL files in Cura, seamlessly upload them to Creality Cloud, and gain remote control over any 3D printer.",
  ...
  home_rankRemark:
    'The dynamic leaderboard highlighting the most popular 3D models and designers',
  ...
  home_userSayRemark:
    'Discover what users have shared about their experience with Creality Cloud',
  home_userSayTitle: 'Testimonials on Creality Cloud Experience',
  hot_sarech: 'Popular searches',
  iePage:
    'The version of the browser you are using is too low, you will not be able to view and use this site properly, please change your browser.',
  ...
  importCreality_importTipCn:
    'Some of the model files may be lost due to system network connections. Please download the missing files manually from Crealitycloud.cn and edit these files on Creality Cloud.',
  importCreality_importTipCom:
    'Some of the model files may be lost due to system network connections. Please download the missing files manually from Crealitycloud.com and edit these files on Creality Cloud.',
  importCreality_importTips:
    'Only those models set as the Public can be imported.',
  importCreality_insufficientStorage:
    'Insufficient Storage. Please free up your space.',
  importCreality_loginCopyModelTip:
    'Copyright alert: Creality Cloud protects the copyright of designers. Please import those models that belong to you. You shall be responsible for any disputes resulting from such unauthorized importing.',
  importCreality_loginTipCn:
    'Please log in to your registered account on Crealitycloud.cn for identity verification purposes.',
  importCreality_loginTipCom:
    "Please log into your account registered on Crealitycloud.com so that we can verify it's you. If you registered your account via Facebook, Google, etc. Please log in to your account on Crealitycloud.com and bind your email address.",
  importCreality_loginTitleCn:
    ' Log into Your Account registered on Crealitycloud.cn',
  importCreality_loginTitleCom:
    'Log into Your Account registered on Crealitycloud.com',
  importCreality_noImportModelList:
    'Nothing can be imported from this account.',
  ...
  importCreality_payModelNumTip4:
    '. The paid models will be automatically set as',
  ...
  index_k:
    'creality cloud, creality cloud app, creality 3d models, creality models, crealitycloud, creality model library, creality cloud slicer, creality stl, creality cloud pc, creality cloud for pc, creality cloud download',
  ...
  leaderboard_left_time_introduce_cn:
    'The score is calculated based on the time in the GMT+8 time zone (Beijing Time).',
  leaderboard_left_time_introduce_com:
    'The score is calculated based on the time in the GMT-5 time zone (Eastern Standard Time).',
  leaderboard_likes: 'Likes',
  leaderboard_modelDeleted:
    'Sorry! The model has been deleted. Please explore other models.',
  leaderboard_modelName: 'Model Name',
  leaderboard_modelRemoved:
    'Sorry! The model has been removed. Please explore other models.',
  leaderboard_modelReported:
    'This model has been reported. Please explore other models.',
  leaderboard_modelSetPrivate:
    'Sorry! The model has been set as private. Please explore other models.',
  leaderboard_model_price_participating:
    'For models participating in this leaderboard, the price of the model must be greater than ',
  leaderboard_model_updated_countdown:
    'The data is being counted and is expected to be updated at ${updateHours} hours ${updateMinute} mins.',
  leaderboard_model_updated_within:
    'The leaderboard data will be updated within 24 hours at the slowest.',
  ...
  leaderboard_seo_tdk_downloads_d:
    'Discover high-quality 3D models on Creality Cloud download leaderboard.',
  leaderboard_seo_tdk_downloads_t:
    '3D Models Download | 3D Models Leaderboard | Creality Cloud',
  leaderboard_seo_tdk_free_model_d:
    'Discover high-quality free 3D models and the top designers.',
  leaderboard_seo_tdk_free_model_t:
    'Free 3D Models | 3D Models Leaderboard | Creality Cloud',
  leaderboard_seo_tdk_paid_model_d:
    'Discover high-quality paid 3D models and the top designers.',
  leaderboard_seo_tdk_paid_model_t:
    'Paid 3D Models | 3D Models Leaderboard | Creality Cloud',
  leaderboard_seo_tdk_slice_print_d:
    'Discover high-quality 3D models on Creality Cloud slice print leaderboard.',
  leaderboard_seo_tdk_slice_print_t:
    'Slice Print | 3D Models Leaderboard | Creality Cloud',
  leaderboard_seo_tdk_top_sales_d:
    'Discover high-quality top sales 3D models and the top designers.',
  leaderboard_seo_tdk_top_sales_t:
    'Top Sales | 3D Models Leaderboard | Creality Cloud',
  leaderboard_seo_tdk_user_d:
    'Discover high-quality 3D models on Creality Cloud leaderboard and the top users.',
  leaderboard_seo_tdk_user_t:
    'Top Users | 3D Models Leaderboard | Creality Cloud',
  ...
  leaderboard_tab_title_model_comment:
    'The score is calculated by multiplying the cumulative number of model comments within the current time period.',
  leaderboard_tab_title_model_favorites:
    'The score is calculated by multiplying the cumulative number of model favorites within the current time period.',
  leaderboard_tab_title_model_likes:
    'The score is calculated by multiplying the cumulative number of model likes within the current time period.',
  leaderboard_tab_title_model_rank:
    'The ranking is determined based on the total score accumulated within the current time period.',
  leaderboard_tab_title_model_sales:
    'The score is calculated by multiplying the cumulative number of model sales within the current time period.',
  leaderboard_tab_title_model_score:
    'Total Score = Model Download Users (5 points/person)<br> + Slicing Users (8 points/person) + Favorites (4 points/each)<br> + Likes (1 point/each) + Printing Users (10 points/person)<br> + Sales (10 points/each) + Comments (3 points/each).',
  leaderboard_tab_title_model_score_desc:
    'Total Score = Model Download Users + Slicing Users + Printing Users + Likes + Favorites + Sales + Comments.',
  leaderboard_tab_title_model_usage:
    'The number of users during the current time period for (model downloads + model slicing + model printing).',
  leaderboard_tab_title_model_use_downloads:
    'The score is calculated based on the cumulative number of unique users who have downloaded the model within the current time period.',
  leaderboard_tab_title_model_use_sales:
    'The score is calculated based on the cumulative number of model sales within the current time period.',
  leaderboard_tab_title_model_use_slice_print:
    'The score is calculated based on the cumulative number of unique users who have both sliced and printed the model within the current time period.',
  leaderboard_tab_title_user_favorites:
    'The score is calculated by multiplying the cumulative number of model favorites within the current time period.',
  leaderboard_tab_title_user_follower:
    'The score is calculated by multiplying the cumulative number of followers gained by a user within the current time period.',
  leaderboard_tab_title_user_good_model:
    'The score is calculated by multiplying the number of original models uploaded within the selected time range by 30 points per model.',
  leaderboard_tab_title_user_good_model_week:
    'The score is calculated by multiplying the number of original models uploaded within the selected time range by 30 points per model, with a maximum score of 900 points.',
  leaderboard_tab_title_user_likes:
    'The score is calculated by multiplying the cumulative number of model likes within the current time period.',
  leaderboard_tab_title_user_score:
    'Total score = High-quality models (30 points/each)<br> + Download users (5 points/person) + Slicing users (8 points/person)<br> + Printing users (10 points/person) + Likes (1 point/each)<br> + Favorites (4 points/each) + Followers (5 points/each).',
  leaderboard_tab_title_user_score_desc:
    'Total score = High-quality models + Download users + Slicing users + Favorites + Followers.',
  leaderboard_tab_title_user_use_model:
    'The number of users during the current time period for (model downloads + model slicing + model printing).',
  leaderboard_tips:
    'Statistics for these rankings are automatically generated by the system. If you have any questions, please contact customer service.',
  leaderboard_top: 'Top ',
  leaderboard_top1: '',
  leaderboard_upModel: 'New Models',
  leaderboard_usage: 'Usage',
  leaderboard_userDes:
    'The usage is calculated by all slices, prints, and downloads of the models.',
  ...
  lightCuring_sliceTip:
    'Tips:  It is officially tested, please feel free to print. Estimate the size of the printer and model before you change device. The filament is recommended to print. If you want to use other filaments, please reset the parameters first!',
  ...
  loginForm_bindPhoneTip:
    'Note: Verified phone number must be bound for your account security according to relevant national policies and regulations.',
  ...
  loginForm_passwordError:
    'Password should be 8-16 characters long with digits and characters.',
  ...
  loginForm_subscribe:
    'Subscribe to Creality Cloud newsletter and receive the latest 3D printing innovations.',
  loginForm_verifyCodeErr: 'The code is Error',
  logoutCareMsg:
    "You've initiated an account deleting application that causes an abnormal use of current functions",
  logoutGroupMsg:
    "You've initiated an account deleting application that causes an abnormal use of current functions",
  ...
  m_cs_device_match_desc:
    'For a better print effect, the selected printer for slicing must strictly match the printer for printing. <span>It will only display the corresponding slice files for the printer [${sliceDeviceName}].</span>',
  m_cs_device_match_title: 'Strictly Matching',
  m_cs_device_other_title: 'Slice with different printers',
  m_cs_dont_match_tips:
    'The printer type of the slice file does not match the selected printer. <span>Please make sure that the slice file can be printed normally</span>, or it will cause <span>inevitable damage to the device!</span>',
  m_cs_expand_more_title: 'See more',
  m_cs_math_no_data_tips: 'No sliced files for [${device}] device.',
  m_cs_no_printer_name_tips:
    'Unable to recognize the printer type for the slice file. <span>Please make sure that the slice file can be printed normally</span>, or it will cause <span>inevitable damage to the device!</span>',
  m_cs_other_device_match_title: 'Slice with different printers',
  m_cs_print_stop_err_tips:
    'Your operation may be delayed after tapping on [Terminate]. If the termination does not work, please try again later!',
  ...
  m_cs_text_print_state_tips:
    'We detected that the print has exceeded the estimated print time. The device may have abnormal data synchronization status and cannot transmit data normally.',
  m_cs_text_select_pick_tip_1:
    'For a better print effect, the selected printer for slicing must strictly match the printer for printing. <span>It will only display the corresponding slice files for the printer [${internalName}].</span>',
  m_device_print_sonic_scree_connect:
    'Please check whether the Printer and the Sonic Pad are connected.',
  m_device_task_print_result_fail:
    'Failed to send the print command, please try again',
  ...
  m_devices_automatic_leveling_hint:
    'The auto-bed leveling will measure the distance the height of your build plate at different points; to ensure that the nozzle maintains the same distance from the bed at all points and improve your print quality. The whole process will take 10 minutes.',
  m_devices_cavity_temperature: 'Chamber Temp',
  m_devices_check_finish: 'Printer auto-detection completed.',
  m_devices_check_hint:
    "Kindly ensure the cleanliness of the hot bed's surface and nozzle before positioning the build plate. It will take about 15 minutes for the whole automatic detection process.",
  m_devices_check_printing_waring:
    'Auto-detection is not supported while printing. ',
  m_devices_check_status_msg:
    'Please do not touch the printer when detecting. The whole process will take <span>about 15 minutes</span>. You can set other parameters when finished.',
  ...
  m_devices_fan_picture_tips:
    'The position of the ${fanName} is as the picture shows.',
  m_devices_gcode_tips: 'There is no printers for the sliced file.',
  m_devices_high_space_log: 'Logs',
  m_devices_high_space_log_desc:
    'Including logs file and statistics. It will not affect the normal use after clearing.',
  ...
  m_devices_in_status_title:
    'Please wait for the filament feeding complete to set other parameters.',
  ...
  m_devices_lcd_machine_status_2:
    'The Printer is leveling, please try again later',
  m_devices_lcd_machine_status_3:
    'Auto homing in progress. Please try again later.',
  m_devices_lcd_machine_status_4:
    'Cleaning in progress. Please try again later.',
  m_devices_lcd_machine_status_5:
    'Updating in progress. Please try again later',
  m_devices_lcd_machine_status_6:
    'Duplicating files to the Printer. Please try again later',
  m_devices_mode_standard: 'Normal',
  m_devices_open: 'Enable',
  m_devices_open_ai_check_jump:
    'You can enable settings in <span> Workbench> Device [Settings]> AI Print Detection</span>.',
  m_devices_open_ai_check_msg:
    'Enable <span>[${selfTest}]</span> to improve your print quality. By enabling, the printer will execute a print calibration before start printing',
  m_devices_out_in_hint:
    'The nozzle temperature will be automatically heated to the default before feeding or retracting the filament.',
  m_devices_out_in_msg:
    'You need to adjust the nozzle temperature for special filaments, such as PETG, TPU, and Nylon. Check different <span>temperature values here></span>',
  m_devices_out_material: 'Retracting Filaments',
  m_devices_out_or_in_dialog_2: 'Nozzle Temp Settings: Print Temp + 20℃',
  m_devices_out_or_in_dialog_3:
    'E.g.: The nozzle temp is <span>260℃+20℃。</span> ',
  m_devices_out_or_in_dialog_msg:
    'The nozzle temperature is set to 240°C by default when the filament is fed and retracted, and it can be adjusted again according to your need. It’s highly recommended to adjust the nozzle temperature for special filaments such as PETG, TPU, and Nylon.',
  ...
  m_devices_out_status_title:
    'Please wait for the filament retracting complete to set other parameters.',
  m_devices_power_off_success_tip:
    'The printer is powered off successfully. It will be offline within 10 minutes.',
  m_devices_print_consumables_contine:
    'Please click the [Continue] button on the printer to continue printing.',
  m_devices_print_failure: 'Print failure. Please try again.',
  m_devices_print_repo_plr_status:
    'The device is powered on, Do you want to continue printing?',
  m_devices_print_report_consumables:
    'Filament runout. Please add another filament before continuing printing.',
  m_devices_print_sermoon_v1_consumables:
    'The device may stop printing if you ran out of filament or opened the door of the device.',
  m_devices_recover_printing_btn: 'Recover printing',
  m_devices_sonic_un_powered:
    'The device is power on. Please confirm whether to continue printing on Sonic Pad.',
  m_devices_speed: 'Speed',
  m_devices_state_ai: 'Auto detecting......',
  m_devices_state_check_title: 'AI Detection',
  m_devices_state_fix_des:
    'By enabling print calibration, the printer will execute calibration before doing print jobs.',
  ...
  m_devices_state_msg_4:
    'The first layer detection helps to detect the failure of the first layer during the printing process. The whole process is expected to last about 5 minutes.',
  m_devices_state_note_2: 'Pause printing when a print failure  is detected',
  m_devices_state_tip:
    'AI detection will help detect anomalies during the printing process.',
  ...
  m_devices_text_select_other_tip_1:
    'It may lead to an unsatisfactory print effect if you use different printers for slicing and printing. <span>The system will slice based on the size of the slice file and the print size of the device.</span>',
  m_devices_text_select_other_tip_2:
    'It may lead to an unsatisfactory print effect if you use other slices with different printers for printing. <span>The system will slice based on the size of the slice file and the print size of the device.</span>',
  ...
  m_devices_vibration_optimization_hint:
    'By turning this on, it can help reduce the impact of vibrations on print quality and reduce or eliminate ghosting in prints. The whole process will take about 5 minutes.',
  m_model_free_space_text: 'Free up space: ',
  m_model_share_dialog:
    'Are you sure you want to set the selected ${num} models as public?',
  m_model_share_fail_info: 'Reasons of failure:',
  m_model_share_fail_info1:
    '1.The model has been published successfully, but the current page is not refreshed.',
  m_model_share_fail_info2:
    '2. The required information for the model is missing.',
  m_model_share_fail_info3:
    '3. The infringement model is not allowed to be disclosed.',
  m_model_share_toast:
    "You've selected ${all} models, <span>${fail}</span> of which failed to be set as public.",
  m_model_share_toast1: "You've set ${num} models as public.",
  m_model_share_toast2:
    'The ${num} models  you selected failed to set as public.',
  ...
  mall_UpgradeToPremiumUnlock:
    'Upgrade to Premium to unlock more exclusive missions!',
  ...
  mall_blockText1:
    "days due to violations of our terms. You won't be able to earn and use Cuvacoins until your account is enabled. If you think that your account was disabled by mistake, please contact us",
  ...
  mall_detailPlace:
    'Street address or P.O. Box. Apt, suite, unit, building, floor, etc.',
  ...
  mall_gitBtn: 'Rewards',
  mall_gitExpress:
    'Insufficient user level. Please increase your level first by earning XP.',
  ...
  mall_goodsSuccess:
    'We will ship your goods as soon as possible.Check your tracking number in redeem list',
  mall_goodsUp:
    'Sorry, you have reached your daily limit for redeeming products. ',
  ...
  mall_kwB: 'Cuvacoins',
  mall_kwBeansNo:
    'You do not have enough Cuvacoins for this product. Please exchange other available products.',
  ...
  mall_orderDealStatusTip:
    'Process... It will be processed within 7-10 business days.',
  mall_orderNum: 'Order #',
  ...
  mall_pleaseMemberExclusive:
    'This is a Premium member-exclusive mission. Please upgrade your plan to premium and unlock the mission. ',
  ...
  mall_remarkPlaceholder:
    '[Optional] Write down the color,type,or size if necessary',
  ...
  mall_taxTips:
    'The country for the selected shipping address requires tax identification information. Please proceed to provide it.',
  mall_textGit: 'Daily maximum quantity of redeeeming:',
  mall_textGit1: '',
  mall_tips: 'Note',
  mall_tipsAddress:
    'Note: This address will be set as the primary shipping address by default for each order.',
  ...
  manage_medal_top_tip:
    'The badges will be displayed in Personal Center, model detail page, and post. You can show up to 3 badges to the public.',
  manage_wear_text: 'Manage Badge',
  manufacturerAgr_contFive1:
  ...
  manufacturerAgr_contFive2Child2:
    '2.2 Publishing contact information or third-party information. It refers to publishing contact information and third-party platform information to explicitly or implicitly guide customers to cooperate or trade the printing service in private. including but not limited to:',
  manufacturerAgr_contFive2Child2li1:
    '2.2.1 Publish contact information such as phone numbers, social account and other contact information;',
  manufacturerAgr_contFive2Child2li2:
    '2.2.2 Providing information that implies advertising or contact information, such as WeChat me, see my bio, WeChat in personal profile, or surprise in personal profile, QR code, etc, guiding customers to contact in private.',
  manufacturerAgr_contFive2Child2li3:
    '2.2.3 Publish third-party platform information, such as third-party platform watermark, platform name logo, store name, website link;',
  manufacturerAgr_contFive2Child3:
    '2.3 Sending private messages or phone calls. It refers to the behavior of manufacturers to guide customers to conduct private transactions by giving hints or explicit indications through communication tools such as chat tools and telephones during the business process.',
  manufacturerAgr_contFive3:
    '2. The Policy is effective on October 15, 2022, with terms updated based on the platform development. Please pay attention to the official dynamic notice.',
  manufacturerAgr_contFour1: '1. Creality Cloud charges a platform ',
  manufacturerAgr_contFour1Bold:
    ' service fee of ¥399 /year, and manufacturers who signed up before December 31, 2022, can enjoy a free service fee.',
  manufacturerAgr_contFour2:
    '2. Creality Cloud has the right to adjust the service fees, and you will be notified in the form of an announcement on the site before any changes happened.',
  manufacturerAgr_contOne1:
    '1. The content of this Policy includes the main text and all kinds of rules that Creality Cloud has released or may release in the future. All rules are an integral part of this Policy and have the same legal effect as the main text of this Policy. ',
  manufacturerAgr_contOne2:
    '2. By using Creality Cloud 3D Printing Service, it means that you have read, understood, and agree to accept all terms and conditions of this Policy (hereinafter collectively referred to as “Terms”).',
  manufacturerAgr_contOne3:
    '3. Creality Cloud reserves the right to change these Terms at any time. Such amended terms and conditions shall be effective upon posting on the Creality Cloud website or through other reasonable methods. Creality Cloud will take reasonable efforts to post notices on the site regarding any changes to these terms and conditions. Please check the terms and conditions published on this site regularly to ensure that you are aware of all the terms governing the site and the Services (refers to 3D Printing Service). You are responsible for any consequence or damages caused by yourself. If you do not agree to all of the terms and conditions described below, do not access or use the Service. If you continue to use the Service, it will be deemed that you have accepted all terms, and the updated terms shall prevail for any dispute arising. ',
  manufacturerAgr_contThree1: '1. Price',
  manufacturerAgr_contThree1Child1:
    '1.1 To improve the efficiency of the quotation of an order, the manufacturer can check the SMS notification sent by Creality Cloud to confirm his order. Creality Cloud gives Cuvacoin rewards to the manufacturer who gives a quote to the customer and confirms the 3D printing service order within 2 hours. ',
  manufacturerAgr_contThree1Child2:
  ...
  manufacturerAgr_contThree1Child3:
    '1.3 The manufacturer should make a clear description of your quote.',
  manufacturerAgr_contThree1Child4:
    "1.4 The manufacturer who has not offered his quote for more than 2 hours, may get a bad influence on your store's reputation and ratings, and thus affects the platform to send you orders.",
  manufacturerAgr_contThree1Child5:
    '1.5 The manufacturer who fails to offer his quote for more than 2 hours for 5 consecutive times within a month or refuses to offer quotes, may face a store close penalty.',
  manufacturerAgr_contThree1Child6:
    '1.6 The manufacturer should give customers reasonable explanations and suggestions within 2 hours when he is not offering service.',
  manufacturerAgr_contThree2: '2.Delivery',
  manufacturerAgr_contThree2Child1:
    '2.1 The manufacturer shall perform the entrustment relationship with the customer, and shall not transfer the order to a third party without written permission from Creality Cloud or the customer.',
  manufacturerAgr_contThree2Child2:
    '2.2 The manufacturer shall upload the actual picture of the printed object (the picture must be true and valid) and confirm with the customer before shipping. Those who finished uploading shipping pictures can get Cuvacoin rewards.',
  manufacturerAgr_contThree2Child3:
    '2.3 The manufacturer shall upload the tracking number of the object the first time when it is shipped.',
  manufacturerAgr_contThree2Child4:
    '2.4 Creality Cloud will launch incentive programs to reward manufacturers, such as cash, filament, and Cuvacoins. For more detailed information, please follow up on the notice and announcement released by Creality Cloud.',
  manufacturerAgr_contThree2Child5:
    '2.5 The manufacturer shall not take any responsibility for the failures of delivering orders due to force majeure factors including but not limited to natural factors (such as fire, typhoon, flood, hail, rainstorm, etc.); political factors (such as government expropriation, war, etc.); social factors (such as anti-epidemic, parade to protest, etc.).',
  manufacturerAgr_contThree3: '3. Complaint',
  manufacturerAgr_contThree3Child1:
    'We offer a great way to help manufacturers handle complaints from the customer. ',
  manufacturerAgr_contThree3Child2:
    '3.1 If you receive a malicious complaint, you can ask for an appeal on Creality Cloud. There will be no effect on your store rating and reputation as long as the appeal is approved. ',
  manufacturerAgr_contThree3Child3:
    '3.2 If you come across problems during the printing process, such as printing failure, filament supplies insufficiency, or shipping problems, please communicate with the customer in a friendly manner, and if both parties cannot solve the problem, you can connect to our customer service on Creality Cloud.',
  manufacturerAgr_contThree3Child4:
  ...
  manufacturerAgr_contTwo1Child2:
    '1.1 The ability to check the printability of the 3D model;',
  manufacturerAgr_contTwo1Child3: '1.2 The ability to slice the 3D model;',
  manufacturerAgr_contTwo1Child4:
    '1.3 The ability to provide post-processing techniques, such as support removal, sanding, vapor smoothing, priming and painting, polishing, etc;',
  manufacturerAgr_contTwo1Child5:
    '1.4 The ability to set a reasonable price for your service;',
  manufacturerAgr_contTwo1Child6:
    '1.5 The ability to give your customer reasonable explanations and suggestions when you are not offering service.',
  manufacturerAgr_contTwo2: '2.Copyright',
  manufacturerAgr_contTwo2Child1:
  ...
  manufacturerAgr_contTwo2Child2:
    "2.2 The manufacturer cannot disclose the customer's orders without any permission.",
  manufacturerAgr_contTwo2Child3:
    '2.3 The manufacturer cannot disclose the data or personal information of the customer in any form to any third parties who do not assume an obligation of confidentiality.',
  manufacturerAgr_contTwo2Child4:
    '2.4 The manufacturer shall be responsible for storing and protecting the customer data when offering a 3D printing service.',
  manufacturerAgr_contTwo2Child5:
    '2.5 If any behavior of data leakage is found, Creality Cloud will take effective measures and prevent further expansion of the leakage, and take legal measures at the same time.',
  manufacturerAgr_contTwo2Child6:
    '2.6 If the manufacturer violates the above commitments, he/she will bear the economic loss and reputation damage caused to the customer accordingly.',
  ...
  medal_buy_model_badge_lebel_text_tip:
    "You've purchased ${metalNum} orders. You need to purchase ${need} more orders to upgrade your badge to level ${level}. ",
  ...
  medal_mei: ' ',
  medal_modeler_badge_lebel_text_tip:
    'Your current score is ${get}. You need to get a score of ${need} to upgrade your badge to level ${level}.',
  ...
  member_card_tip:
    'All check-in cards will be issued to your account after you upgrade the plan.',
  member_center_desc:
    'Take your 3D printing to the next level with powerful printing features, exclusive free 3D models, and advanced cloud slicing!',
  ...
  member_draws_num_tip:
    'All lucky draw entries will be issued to your account after you upgrade the plan.',
  ...
  member_error_max:
    'Sorry, you have purchased the premium plan for the maximum period of time. You can use your premium plan for a while and then renew it again.',
  ...
  member_payHint:
    'The storage plan will take effect immediately after successful payment. Please pay attention that the storage space will be reclaimed after your storage plan expired. But Your file will still retain.',
  member_payIn: 'Top Up',
  ...
  member_platform_tip:
    'Membership benefits are applicable to both the Creality Cloud app and website.',
  ...
  member_specialty_desc_1:
    'Provide secure online payment and support WeChat and Alipay payment.',
  member_specialty_desc_2:
    'Delivering secure products and unparalleled user experiences.',
  member_specialty_desc_3:
    'Professional customer service team provides reasonable solutions for your problems.',
  member_specialty_desc_4:
    'Unlock premium membership benefits and enjoin services immediately upon payment.',
  ...
  member_vipService_textArray1:
    'Thanks for using Creality Cloud paid membership system.',
  member_vipService_textArray10: '',
  member_vipService_textArray100: '',
  member_vipService_textArray101:
    '6. Account Fraudulently Used, Stolen and Lost',
  member_vipService_textArray102: '',
  member_vipService_textArray103:
    '6.1 In the event that your account and password are fraudulently used or stolen by others, or used in any other situation without your legal authorization:',
  member_vipService_textArray104: '',
  member_vipService_textArray105:
    '(1) You should immediately send a request and notify us to take measures in an effective way as required, including but not limited to customer services, email, etc.',
  member_vipService_textArray106:
    '(2) You should provide valid account identity information consistent with your registered information or any relevant certification and verification information required by Creality Cloud.',
  member_vipService_textArray107:
    '(3) Creality Cloud will take corresponding account management measures according to your request and verify your account.',
  member_vipService_textArray108:
    '(4) You shall be responsible for all losses caused by corresponding measures that the Creality Cloud takes according to your request.',
  member_vipService_textArray109:
    '(5) Creality Cloud reserves the right to refuse your request if you do not have any valid information to prove your account. You will be responsible for any loss caused.',
  member_vipService_textArray11:
  ...
  member_vipService_textArray119:
  ...
  member_vipService_textArray129:
    'The services you use may be different due to the different software versions, devices, operating systems you use, which may cause inconvenience. In this situation, you understand and agree to waive the relevant responsibilities of Creality Cloud.',
  member_vipService_textArray13:
    'If you are under the age of 18, please read and confirm the terms of this agreement accompanied by a legal guardian.',
  ...
  member_vipService_textArray134:
  ...
  member_vipService_textArray136:
  ...
  member_vipService_textArray140:
    'The Service is a paid service provided by Creality Cloud. You must pay the corresponding fee according to the charging standard of this service before you can use it. Creality Cloud reserves the right to modify and change the relevant benefits, charging standards, payment methods of this service. The aforementioned modification and changes will be displayed on the corresponding page. Creality Cloud reserves the right to give different discounts to premium members who purchase and renew their plans. The specific preferential policies are subject to the information announced on the relevant page.',
  member_vipService_textArray141: '',
  member_vipService_textArray142:
    'You hereby understand and agree that you will enjoy different value-added services, tariffs, or benefits for participating in the event.',
  member_vipService_textArray143: '',
  member_vipService_textArray144: '6. Payment',
  member_vipService_textArray145: '',
  member_vipService_textArray146:
    '6.1 You should pay according to the payment contract through existing payment methods. Creality Cloud now supported Alipay, Apple Pay, Google Pay, PayPal payment. You won’t be entitled to a refund or credit from us under any circumstance once the payment is made.',
  member_vipService_textArray147: '',
  member_vipService_textArray148:
    '6.2 You shall not upgrade the Service for yourself or others in any of the following ways or purposes:',
  member_vipService_textArray149: '',
  member_vipService_textArray15: '<b>Ⅱ. Definition</b> ',
  member_vipService_textArray150:
    '(1) Upgrade the Service for the purpose of non-personal use such as profit and business.',
  member_vipService_textArray151:
    '(2) Upgrade the Service through any program or software.',
  member_vipService_textArray152:
    '(3) Upgrade the Service by any improper means or in a way that violates the principle of good faith;',
  member_vipService_textArray153:
    '(4) Upgrade the Service in a way not specified by Creality Cloud.',
  member_vipService_textArray154:
    '(5) Upgrade the Service by infringing the legitimate rights and interests of Creality Cloud or other users.',
  member_vipService_textArray155:
    '(6) Upgrade the Service by other means that violate relevant laws, administrative regulations, national policies, ',
  member_vipService_textArray156: '',
  member_vipService_textArray157: '7. Service Period',
  member_vipService_textArray158: '',
  member_vipService_textArray159:
    '7.1 The validity period of the Service is subject to the monthly or yearly plan billing you choose and pay. You can log in to see your validity period in Member Center.',
  member_vipService_textArray16: '',
  member_vipService_textArray160: '',
  member_vipService_textArray161:
    '7.2 If any network failure or crash occurs to affect your validity period, you understand that Creality Cloud needs reasonable time to resolve faults, server repairs, adjustments, upgrades, and deal with infringement by third parties, to minimize the impact for users as much as possible.',
  member_vipService_textArray162: '',
  member_vipService_textArray163: '8. Rules',
  member_vipService_textArray164: '',
  member_vipService_textArray165:
    '8.1 Do not use this Service to infringe any intellectual property rights, property rights, and reputation rights of any users, Creality Cloud, and any third party.',
  member_vipService_textArray166: '',
  member_vipService_textArray167:
    '8.2 The Service is a paid service. Creality Cloud reserves the right to investigate the responsibility of the perpetrator and ask for compensation for those who infringe or destroy the payment system.',
  member_vipService_textArray168: '',
  member_vipService_textArray169:
    '8.3 Do not use this Service to conduct any acts that endanger or are suspected of endangering minors.',
  member_vipService_textArray17: '1. The Member',
  member_vipService_textArray170: '',
  member_vipService_textArray171:
    '8.4 Do not use this Service to engage in any behavior that violates laws, regulations, policies, public order and good customs, social morality, etc.',
  member_vipService_textArray172: '',
  member_vipService_textArray173: '9. Others',
  member_vipService_textArray174:
  ...
  member_vipService_textArray178:
    '1. When using the Service, you shall not commit the following behavior to breach the Agreement:',
  ...
  member_vipService_textArray182:
    '1.2 Violating the laws, regulations, rules, and any normative provisions with legal effect.',
  member_vipService_textArray183: '',
  member_vipService_textArray184:
    '1.3 Destroying or interfering with this Service that Creality Cloud provides to any third party.',
  member_vipService_textArray185: '',
  member_vipService_textArray186:
    '1.4 Conducting behaviors that endanger computer network security.',
  member_vipService_textArray187: '',
  member_vipService_textArray188:
    '1.5 Conducting behaviors that cause adverse effects on the services provided by Creality Cloud and related third parties (including authors and partners), and infringe on the legitimate interests of third parties or other users.',
  ...
  member_vipService_textArray190:
    '1.6 Being determined by the relevant departments to infringe the legitimate rights and interests of any third party.',
  member_vipService_textArray191: '',
  member_vipService_textArray192:
    '1.7 Using the Service to obtain illegal benefits, including but not limited to illegal profit-making through resale, transfer, sub-authorization, etc.',
  member_vipService_textArray193: '',
  member_vipService_textArray194:
    '1.8 Other acts that infringe on the legitimate interests of Creality Cloud.',
  ...
  member_vipService_textArray199:
    'You confirm and agree that Creality Cloud has the right to one or more of the following measures to deal with the misbehavior that breaches the Agreement. ',
  member_vipService_textArray2: '',
  member_vipService_textArray20: '',
  member_vipService_textArray200: '',
  member_vipService_textArray201:
    '2.1 Taking technical measures to delete, block or disconnect related information.',
  member_vipService_textArray202: '',
  member_vipService_textArray203:
    '2.2 Suspending or terminating a part of or all of the Service.',
  member_vipService_textArray204: '',
  member_vipService_textArray205:
    '2.3 Creality Cloud does not need to make a refund to you if you violated the rules or regulations of this Service. And your unused services fees will belong to Creality Cloud as liquidated damages. You shall be responsible for the loss in your account (including but not limited to reduction and loss of models, slice data and virtual products, etc.) and compensation such as attorney fees, litigation fees caused by Creality Cloud.',
  member_vipService_textArray206: '',
  member_vipService_textArray207: '3. Compensation',
  member_vipService_textArray208: '',
  member_vipService_textArray209:
    'If your misbehavior of breaching the Agreement directly lead to an irretrievable loss to Creality Cloud and its affiliates, such as direct economic losses, loss of goodwill, and indirect economic losses (like compensation, settlement, attorney fees, and litigation fees), you shall be responsible for the compensation and all losses for Creality Cloud. ',
  member_vipService_textArray21:
    '<b>In addition, there will be more self-selected paid plans for you to choose from in the future based on your needs.</b>',
  member_vipService_textArray210: '',
  member_vipService_textArray211: '<b>Ⅴ. Disclaimers</b>',
  member_vipService_textArray212: '',
  member_vipService_textArray213:
  ...
  member_vipService_textArray215:
    '2. If you come into any content that violates the laws, regulations, or anything that makes you feel uncomfortable or even fear or disgusted, please give online feedback to contact us. We will be appreciated your help.',
  member_vipService_textArray216: '',
  member_vipService_textArray217:
    '3. You should make independent judgments when you watch, share, learn from, reprint, repost any content or post in Creality Cloud. You shall be solely responsible for any damage to yourself or any third parties caused by your user behaviors.',
  ...
  member_vipService_textArray223:
    '2. Creality Cloud may get involved in third-party intellectual property rights. The third-party will make requirements for you to use such rights based on this Agreement. Creality Cloud will notify you of the requirements in an appropriate manner, and you should abide by.',
  member_vipService_textArray224: '',
  member_vipService_textArray225:
    '<b>Ⅶ. Interruption, Termination & Changes</b>',
  member_vipService_textArray226: '',
  member_vipService_textArray227:
    '1. Creality Cloud will maintain the normal operation of related systems and services in accordance with generally reasonable techniques and methods. However, we have the right to interrupt or terminate the provision of this service in the following situations:',
  member_vipService_textArray228: '',
  member_vipService_textArray229:
    '1.1 Voluntarily interruption or termination by the users, including but not limited to the failure to renew the plan upon expiration.',
  member_vipService_textArray23: '2. The Agreement',
  member_vipService_textArray230: '',
  member_vipService_textArray231:
    '1.2 Voluntarily interruption or termination by Creality Cloud for users’ violation of the Agreement.',
  member_vipService_textArray232: '',
  member_vipService_textArray233:
    '1.3 Voluntarily interruption or termination by Creality Cloud for a national or relevant official department request, or force majeure.',
  member_vipService_textArray234: '',
  member_vipService_textArray235:
    '1.4 Voluntarily interruption or termination by other laws and regulations.',
  member_vipService_textArray236: '',
  member_vipService_textArray237:
    '2. After the interruption or termination of the Service, Creality Cloud has the rights but no obligation to ensure you can receive special prompts or notifications. If you cannot log in or enjoy the Service, Please consult our customer services.',
  ...
  member_vipService_textArray241:
    '3.1 Except for the responsibilities stipulated by law, Creality Cloud shall not bear any responsibility for the user or any third party for the interruption or termination of this Service.',
  ...
  member_vipService_textArray245:
    '3.3 Keep relevant model data for a certain period of time. Other member rights and interests will be changed or reduced according to the regulations of the platform.',
  member_vipService_textArray246: '',
  member_vipService_textArray247:
    '3.4 As for ongoing transactions, Creality Cloud will make a reasonable judgment based on different situations to decide whether to continue or terminate the Service, and whether to refund or deduct relevant fees as liquidated damages.',
  member_vipService_textArray248: '',
  member_vipService_textArray249:
    '4. Creality Cloud will inform you of any possible changes to this Agreement (including but not limited to amendments and adjustments of the terms, member features, rights and interests) according to the stipulations. Please read carefully and decide whether to continue the plan service after the adjustment and changes. If you have no objection to the amendment, you can take the form of accepting the Agreement to continue the service. If you do not agree to the changes, you can stop using the Service immediately.',
  member_vipService_textArray25:
  ...
  member_vipService_textArray253:
    '1. All notices under this Agreement will be published through web announcement, system message, push notification, email, or SMS message. You are regarded as receiving the notice from the date of publication.',
  member_vipService_textArray254: '',
  member_vipService_textArray255:
    '2. You should ensure that your email address and phone number are correct and valid in order to receive the relevant notices. You should log in to your Creality Cloud account to modify your information if any changes happen. You shall be responsible for the losses and legal consequences if you fail to modify.',
  member_vipService_textArray256: '',
  member_vipService_textArray257:
    '3. The notices that the Creality Cloud publishes may have a significant beneficial impact on you. You should pay attention to the corresponding notices in time.',
  ...
  member_vipService_textArray261:
    'If you have any questions, inquiries, suggestions, or complaints about the Service, you can send them to us through the following channels. We will deal with your problems and give feedback as soon as possible once receive your message. ',
  member_vipService_textArray262: '',
  member_vipService_textArray263:
    '1.You can contact the online customer service on the page "Me" inside the Creality Cloud App and submit your feedback.',
  member_vipService_textArray264: '',
  member_vipService_textArray265:
    '2. You can send your feedback through email at teamcloud@creaality.com.',
  ...
  member_vipService_textArray271:
    'This agreement will be effective on the date you use the service. ',
  member_vipService_textArray272: '',
  member_vipService_textArray273: '2. Applicable Laws',
  member_vipService_textArray274: '',
  member_vipService_textArray275:
    "The establishment, commencement, performance, interpretation, and dispute resolution of this agreement shall be governed by the laws of the People's Republic of China (Mainland) (excluding conflict of laws).Dispute",
  member_vipService_textArray276: '',
  member_vipService_textArray277: '3. Dispute Resolution',
  member_vipService_textArray278: '',
  member_vipService_textArray279:
    "Any dispute, claim, or controversy arising out of or relating in any way to the Service between you and Creality Cloud, you should first resolve through friendly negotiation. If the negotiation fails, you agree to submit the dispute to the jurisdiction of the people's court where the defendant is located.",
  member_vipService_textArray28: '',
  member_vipService_textArray280: '',
  member_vipService_textArray281: '4. Term Title',
  member_vipService_textArray282:
    'The headings of all terms in this Agreement are for reading convenience only, have no actual meaning in themselves, and cannot be used as the basis for the interpretation of the meaning of this agreement.',
  member_vipService_textArray283: '',
  member_vipService_textArray284: '5. Effectiveness',
  member_vipService_textArray285:
    'The terms of this Agreement are partially invalid or unenforceable for any reason, the remaining terms shall remain valid and binding on both parties.',
  ...
  member_vipService_textArray35:
    'The membership rules refer to all content related to the terms and rules of users, events, announcements, prompts, notices, online FAQs, etc, provided and irregularly revised by Creality Cloud.',
  member_vipService_textArray36: '',
  member_vipService_textArray37: '5. Uploaded Data',
  member_vipService_textArray38: '',
  member_vipService_textArray39:
    'The term "Data" refers to all kinds of data generated while viewing Creality Cloud platform and recorded by the server, including but not limited to your login records, uploaded files, virtual item data, behavior logs, purchase logs, comments, membership validity, and assets, etc.',
  ...
  member_vipService_textArray46:
    '● You should abide by public order, respect social morality.',
  member_vipService_textArray47:
    '● You must not endanger the network security. ',
  member_vipService_textArray48:
    '● You must not advocate terrorism, extremism, advocate ethnic hatred, ethnic discrimination.',
  member_vipService_textArray49:
    '● You must not spread violence, obscene and pornographic information, fabricate, spread falsehood Information disrupts economic and social order.',
  member_vipService_textArray5:
    'Creality Cloud provides related services for Creality Cloud members (hereinafter referred to as "the service") in accordance with the following terms. Please read, understand, and abide by the Creality Cloud Membership Service Agreement (hereinafter referred to as "the agreement") carefully. By using the Service (defined below) or signing up for an account, you ("the user" or "the member") are agreeing to these terms, which will result in a legal agreement between you and Creality Cloud (collectively, "the platform", "we", or "us"). ',
  member_vipService_textArray50:
    '● You must not infringe on others’ reputation, privacy, intellectual property rights and other legitimate rights and interests. ',
  member_vipService_textArray51: '',
  member_vipService_textArray52:
    'Creality Cloud reserves the right to terminate the Service to the user who is suspected of the above-mentioned wrongdoing at any time and under any circumstance without prior notice and does not constitute a breach of the Agreement.',
  ...
  member_vipService_textArray56:
    'If you come across any other paid services except for the membership service on Creality Cloud and want to know about the relevant services, please read the rules or service agreements on the relevant pages carefully, and pay attention to the service provider. If you need to pay for that type of service, please contact the service provider.',
  ...
  member_vipService_textArray62:
    'To use the Service, you must first register a Creality Cloud account and become a user of the platform. After logging in to your account, you are deemed as a member of Creality Cloud and own the right and interests within a validity period.',
  ...
  member_vipService_textArray74:
    '(1) The Service is limited to your use in Creality Cloud platform. Any act of separating the',
  member_vipService_textArray75:
    'Service and the platform by illegal means such as cracking, translating, or transcription does not belong to this Agreement. Creality Cloud reserves the right to pursue legal responsibilities and claims against those who disobeyed the rules.',
  member_vipService_textArray76:
    '(2) You should not obtain the Service by stealing, system loopholes, or through any non-official authorized means, including but not limited to transactions, lease, borrowing, sharing, assignment, etc. Any misbehavior like malicious use, or destroying the Service system will not receive relevant protection. Creality Cloud reserves the right to terminate the Service. Those who disobeyed the rules shall be sorely responsible for all losses and liabilities.',
  member_vipService_textArray77:
  ...
  member_vipService_textArray82:
    '(1) The Services is a personal, non-transferable and non-exclusive license granted by Creality Cloud to you based on your commitment to abiding by this Agreement and relevant laws and regulations. It’s for personal use only.',
  ...
  meta_description:
    "Creality Cloud is the world's first all-in-one 3D printing platform that offers 3D model trading, cloud slicing, and remote control printers to make 3D printing easier and smarter for over a million makers from 190 countries and regions.",
  meta_fansTitle: "'s followers and following",
  meta_keyword:
    'Creality Cloud, 3D printing, 3D printable models, 3D model downloads, 3D model website, 3D printing service, Buy 3D printing service, 3D printing community, 3D printer firmware, remote control 3D printers, 3D printing tutorial, slicer, 3D slicer software, 3D printing slicer, slicing software',
  meta_leaderboardDesc:
    'Discover high-quality 3D models and the top designers.',
  ...
  model_category_all_d:
    'Here you can find all 3D models, 3D model collections. Select whatever you like to download and print.',
  model_category_foryou_d:
    'On the basis of your preference, we are selected the most popular 3D models for you.',
  model_category_premium_d:
    'Unlock creativity with all the premium 3D models from Creality Cloud, and elevate your digital projects with top-quality assets.',
  model_category_promotion_d:
    'Elevate your projects with our exclusive 3D Models Promotion! Discover high-quality 3D assets at unbeatable prices.',
  model_category_exclusive_d:
    'Unlock creativity with all the exclusive 3D models from Creality Cloud, and elevate your digital projects with top-quality assets.',
  model_category_K1_d:
    'Unlock creativity with all the K1 related 3D models from Creality Cloud, and elevate your digital projects with top-quality assets.',
  model_category_coupon_d:
    'Unleash your creativity by using the coupon from Creality Cloud to access a variety of 3D models. Revel in top-notch designs at the most affordable prices!',
  model_category_beginner_d:
    "Unlock creativity with Creality Cloud's beginner-friendly 3D models to elevate your digital projects effortlessly.",
  model_category_resin_d:
    'Unlock creativity with all the resin 3D models from Creality Cloud, and elevate your digital projects with top-quality assets.',
  model_category_107_d:
    'Here is the characters 3D models, you can find 3D models of movie, cartoon, game characters to download.',
  model_category_108_d:
    'Download all animals 3D models on Creality Cloud, including cat, dragon, dog, wolf, etc.',
  model_category_109_d:
    'Download all Nature & Plants 3D models on Creality Cloud. You can find 3D print flowers, planter pot, etc.',
  model_category_110_d:
    'A variety of Watercraft 3D models available for download include boats, yachts, ships and other water going vehicles of all kinds.',
  model_category_111_d:
    '3D-printed models have been used in many medical areas. Now find some Biology & Medical 3D models on Creality Cloud.',
  model_category_112_d:
    'If you are a car model collector, you can print any car models by yourself on Creality Cloud vehicles 3D models category.',
  model_category_113_d:
    'A variety of aircraft 3D models are available for download on our 3D model marketplace.',
  model_category_114_d:
    'Architecture & Landscape 3D models files ready to view, buy and download on Creality Cloud 3D model marketplace.',
  model_category_115_d:
    'Most popular Toys & Games 3D models available for download. Are ready for animation, games and VR / AR projects.',
  model_category_116_d:
    'Famous Sculptures & Cultural relics 3D models for 3D print.',
  model_category_117_d:
    'Industrial equipment and manufacturing machinery 3D models free to download on Creality Cloud.',
  model_category_118_d:
    'Useful Gadgets & Electronics 3D models to view, buy, and download include phone holder, micro SD case, headphones stand, etc.',
  model_category_119_d:
    '3D print High-Quality household cool things for your home decoration.',
  model_category_120_d:
    'For sports & outdoor enthusiasts, you can print toys and other things to use when outdoors with these 3D models.',
  model_category_121_d:
    'Find most popular fashion 3D models to 3D print clothes, shoes, sunglasses, masks, etc.',
  model_category_122_d:
    'Explore a wide collection of 3D Food Models on Creality Cloud.',
  model_category_123_d: 'Check out our DIY free 3D print models to download.',
  model_category_124_d:
    '这里是3D打印机相关的3D打印模型分类，你可以找到精美的3D模型进行下载。',
  model_category_125_d: 'Download Others 3D models - Creality Cloud.',
  model_category_127_d:
    '这里是人物相关3D打印模型分类，你可以找到电影，卡通或游戏中的角色3D模型进行下载。',
  model_category_128_d:
    '在创想云你能找到所有与动物相关的3D模型文件，包括猫，狗，龙，狼，等。',
  model_category_129_d:
    '在创想云上下载所有与自然&植物相关的3D模型，包括3D打印的花朵，甚至花瓶等物品。',
  model_category_130_d:
    '如果你是一个车辆模型收藏者，你可以在创想云自主打印任意车辆模型。',
  model_category_132_d:
    '3D模型打印已经在生物医疗广泛应用。你可以在创想云找到与生物和医疗相关的3D模型。',
  model_category_133_d:
    '多种类型3D船艇模型可供下载，包括船、游艇、轮船和其他各种水上交通工具。',
  model_category_134_d: '创想云 3D 模型市场提供多种飞机 3D 模型可供下载。',
  model_category_135_d:
    '可在创想云3D模型市场上查看、购买和下载的建筑和景观 3D 模型文件。',
  model_category_136_d:
    '最受欢迎的玩具和游戏 3D 模型可供下载。为动画、游戏和 VR/AR项目做好准备。',
  model_category_137_d: '这里有最全的著名雕塑和文物 3D 模型供您下载。',
  model_category_138_d: '在创想云上免费下载工业设备和机械制造相关的3D 模型。',
  model_category_139_d:
    '查看、下载和购买有用的电子产品小工具3D模型。包括手机支架、micro SD 外壳、耳机支架等。',
  model_category_140_d: '3D打印高品质家居炫酷物品，搭配您的家居装饰。',
  model_category_141_d:
    '找到当下最流行的时尚3D模型，可3D打印衣服、鞋子、太阳镜、面具等。',
  model_category_142_d:
    '对于运动和户外爱好者，您可以使用这些 3D 模型打印玩具和其他在户外使用的物品。',
  ...
  model_category_306_d:
    '这里是3D打印机相关的3D打印模型分类，你可以找到精美的3D模型进行下载。',
  model_category_3300_d:
    'For 3D print beginners, here are some simple 3D models free download for you. ',
  ...
  model_category_3340_d:
    '对于3D打印初学者，这里有一些简单的3D模型可供您免费下载。',
  model_category_3362_d: '在创想云上探索更多创意3D模型。',
  model_category_3373_d:
    '如果你在寻找可供测试的3D模型，创想云3D模型市场将为你提供便利。',
  model_category_3384_d:
    "Let's show you the printed models, and how to use. Meanwhile, you can find the model file to download as well.",
  model_category_3534_d:
    '如果你想要改装你的3D打印机，这里有一些3D打印机改装模型可供你下载。',
  model_category_361_d:
    '如果您使用的是光固化打印机，那么这些光固化3D模型非常适合您。',
  model_category_k:
    ' models, Creality Cloud, 3d model, stl file,3d printables, stl files for 3d printing, stl file download',
  ...
  modelDetail_birthdayOpenVipTip2:
    'per day and upgrade to Premium to get a special birthday gift.',
  ...
  modelDetail_buyRuleWord1:
    "Creality Cloud respects everyone's creativity and protects the designer's original hard work. Please strictly abide by the CC licenses when sharing the free 3D designs for limited kinds of uses while preserving copyright.",
  modelDetail_buyRuleWord2:
    '3D Model files sold on Creality Cloud have a strict non-commercial, personal use only license. You may not share, transmit, redistribute, remix, duplicate, sell, or resell the 3D model designs or any portion of the designs for any commercial purpose without the express written consent of the original designers or their relevant licensors.',
  modelDetail_buyRuleWord3:
  ...
  modelDetail_buyRuleWord4:
    'If you believe that 3D models residing on the Creality Cloud infringe a copyright or other intellectual property right, please report the models or send a notice of infringement by email to teamcloud@creality.com.',
  ...
  modelDetail_cancelSharingModelGroupAlert:
    'Confirm to cancel sharing this model?',
  ...
  modelDetail_commentContentEmptyWarning:
    'The content of your comment cannot be empty!',
  modelDetail_commentText:
    'Share your print experience with the community and get a chance to win',
  ...
  modelDetail_delCommentAssess:
    'Are you sure you want to delete this comment? By deleting the comment, your reward will be canceled and revoked.',
  ...
  modelDetail_deleteModelAlertOnly:
    'Delete the last file of the model, and the model will be deleted.',
  ...
  modelDetail_editInfoVipTip1:
    'You can get a special gift pack for your birthday.',
  modelDetail_editInfoVipTip2:
    'Select your date of birth. You will get an exclusive gift on your birthday during the premium subscription period.',
  modelDetail_emoji: 'Emoji',
  modelDetail_emptySliceFiles:
    'No prints found for related slice files. Select another printer type and try again.',
  modelDetail_emptySliceFiles2:
    "You haven't sliced the file yet. You can try to batch slice a whole lot of files with Creality Cloud.",
  ...
  modelDetail_goServiceTip:
    '3D Printing Service is live! Order your custom print now.',
  ...
  modelDetail_modelBadTip:
    'You cannot slice the model for the model is damaged.',
  ...
  modelDetail_modelDontExistAlert:
    'This model has been deleted. Do you want to cancel collecting it?',
  modelDetail_modelDownBuyTip: 'You can download the files after purchase.',
  modelDetail_modelDownCancel: 'Cancel',
  modelDetail_modelDownNote:
    'Please do not close or switch the page when the file is downloading.',
  ...
  modelDetail_modelNotSharedAlert:
    'This model is not shared. Do you want to cancel collecting it?',
  modelDetail_modelPackgSetPrice: 'Bundle Pricing',
  modelDetail_modelPackgSetPriceTip1: '',
  modelDetail_modelPackgSetPriceTip2:
    'model items were added to the bundle. You can modify the current price according to your needs.',
  ...
  modelDetail_modelProcessInfo:
    'This model is being processed, please wait for a moment.',
  modelDetail_modelPurchased: 'Purchased',
  modelDetail_modelRemoved: 'Model has been Removed!',
  modelDetail_modelSliTip:
    'You cannot slice the model for the model is in the process of reduction.',
  modelDetail_modelSliceSax: 'Sort by Printer',
  modelDetail_modelTitle: 'Reviews',
  modelDetail_modelTopriceTip:
    'The bundle price divided by the number of models is equal to the single price.',
  ...
  modelDetail_nobuyAllDown:
    'You need to purchase all model files  before download.',
  modelDetail_nobuyAllSlice:
    'You need to purchase all model files  before slicing.',
  modelDetail_nobuyDown:
    'You need to pay for the model before you can download it.',
  modelDetail_nobuySlice:
    'You need to pay for the model before you can slice it.',
  modelDetail_noticeW: 'Notice',
  modelDetail_officeSlice: 'Official slices',
  modelDetail_oncePrice: 'Single',
  modelDetail_oncePriceTip:
    'The bundle price divided by the number of models is equal to the single price.',
  ...
  modelDetail_rateText:
    'Add your reviews and rate the model based on the following evaluation of its printability, utility, level of design detail, etc.',
  ...
  modelDetail_replyContentEmptyWarning:
    'The content of your reply cannot be empty!',
  modelDetail_report: 'Report',
  modelDetail_requestTimeout: 'Network timed out!',
  modelDetail_resetSit: 'Reset',
  modelDetail_reviewBtn: 'OK',
  modelDetail_ruleTipCheck:
    'Tick this box and agree to the terms before payment.',
  modelDetail_selectModelSli:
    "You can only slice those files that you've purchased.",
  modelDetail_selectReportType: 'Please select a report type',
  modelDetail_selectReportTypeWarning: 'Please select a report type!',
  modelDetail_selfModelCollectWarning:
    'Your own models cannot be collected by your self!',
  ...
  modelDetail_taotalPriceTip:
    'The current price is summed up by all the single prices of the models.',
  ...
  modelDetail_tipsText:
    "Let us know if you can't find the 3D printer you want.",
  ...
  modelDetail_vipGoodsTip:
    'Exclusive for Premium members. Upgrade your plan to Premium to redeem this product.',
  ...
  modelGroup_appealDesc:
    "We've received your submission. We'll review your request and you should expect a reply through a system message.",
  modelGroup_appealProcessing: 'In Process',
  modelGroup_appealText:
    'The model has been set as private due to copyright infringement. You can submit an appeal and upload proof of this creation to clarify that you are the owner.',
  modelGroup_appealText1:
    'The model has been set as private due to copyright infringement. Submit an appeal.',
  ...
  modelGroup_certificatesTips:
    'Please upload proof or certificates of your 3D designs.',
  ...
  modelGroup_coverCount:
    'Accepted formats: GIF, JPG, PNG, and more. Drag & drop your images to rearrange the order.',
  ...
  modelGroup_modelDescPlaceholder:
    'Please provide information on what the model is, its print-readiness, technical details and your experience. Try keeping it factual, well-formatted and visually enhanced.',
  ...
  modelGroup_originModelUploadT:
    'Requirements for the copyright certificate or other proof of your original work.',
  modelGroup_originModelUploadTip: 'Please upload proof of your 3D design.',
  modelGroup_originModelUploadWarn:
    "Creality Cloud verifies original content to help protect designers from copyright claims and respects other designers' intellectual property.",
  ...
  modelGroup_warnModelDescMax:
    'Up to 2000 description information can be entered',
  ...
  modelSetting_modelIntroWarnning:
    'Please add the introduction for your model~',
  ...
  modelSetting_sortImageTip:
    'The first image is the cover of the model. You can drag the images to rearrange them.',
  ...
  model_allTag: 'All',
  model_buyAgainTip:
    "You have purchased the model, please don't purchase again.",
  ...
  model_detail_slice:
    'You can find the sliced files in Personal Center>Slices.',
  model_detail_slice_to: 'See my slices',
  model_detail_toast_off:
    'Sorry! Editing is not supported right now. Please clos    6e the discount on this model if you need to modify the price and the model source.',
  ...
  model_model_details_d3:
    ' , all the information you need for a successful print.',
  ...
  model_tag_add_input_pla:
    'Please enter the tags, separate them with "Enter" key to confirm.',
  model_tag_add_max1: 'You can add up to ',
  model_tag_add_max2: ' tags.',
  model_tag_add_use_num: ' Usage',
  model_tag_title_desc:
    'Adding tags to models increases the likelihood of them appearing in search results, thereby enhancing the exposure of the models.',
  model_tags_d1:
    'Explore a collection of 3D models for 3D printing related to ',
  model_tags_d2:
    '. Download the STL files, and bring them to life using your 3D printer. Enjoy the creative process!',
  model_tags_k:
    ', 3D models，3D model download, Creality Cloud, 3D printables, free model download, STL file, free STL file, 3D printer file, 3D printing model, 3D printer object',
  model_tags_t: ' | 3D Models | Creality Cloud',
  model_timeOut: 'Date',
  model_tool_title: 'Batch Model Upload Tool',
  model_upload_tips:
    'You can upload model-related files in formats such as .pdf, .docx, .ppt, .txt, .xls, .png, .jpg, .gif, and more. These files can include model design concepts, slicing parameter explanations, assembly tutorials, and other relevant information.',
  model_upload_title: 'Upload File',
  model_upload_title1: 'required',
  model_upload_title2: 'Other Files (optional)',
  model_upload_title3:
    ', There is no limit to the number of files in the compressed package.',
  ...
  modelerIn_EncourageCreators:
    " We've rolled out a Designer Partnership Program to build a strong relationship with talented 3D designers and reward them for their trust and support. Click to find more details.",
  ...
  modelerIn_GetAnExclusive:
    'Get an exclusive section on Creality Cloud to share and showcase your designs.',
  modelerIn_GetExtraBonus:
    'Get extra bonus for every like, download, and sale from your 3D designs.',
  ...
  modelerIn_PleaseSelectCategories:
    'Tags to describe yourself or your designs. (Up to 3 tags)',
  ...
  modelerIn_SubmittedTips:
    'Thank you so much for joining the program. We will reach out to you regarding the result as soon as possible. The result will be informed to you by push notifications and system messages. Please check your message in time.',
  ...
  modelerIn_applicationApproved:
    'Congrats! Your application has been approved. Now you are an officially verified designer.',
  modelerIn_applicationNotApproved:
    'Sorry, your application has not been approved. You can submit your application again.',
  modelerIn_applicationProcess:
    'Your application is in process. Please be patient.',
  ...
  modelerIn_creatorFundSupportInfo:
    'Get a $30 creator fund to start your 3D project when you sign up for Creality Cloud. This fund support is only for new users who sign up from Nov.14 to Nov 30, 2022.',
  ...
  modelerIn_designerPartnershipProgramTips:
    "Whether you're just starting out or already an established artist, teaming up with our program amplifies your reach and forges authentic relationships within the thriving 3D printing community. With expanded visibility and valuable collaborations, you'll take your brand and talent to new heights.",
  ...
  modelerIn_increaseYourPopularity:
  ...
  modelerIn_joiningTheProgram:
    'What are your expectations after joining the program? (optional)',
  modelerIn_modelDeficiency1: 'Please upload at least  ',
  modelerIn_modelDeficiency2:
    ' original 3D models before applying to be a 3D designer.',
  modelerIn_modelDeficiency3: "You've finished ",
  modelerIn_modelDeficiency4:
    ' original 3D model uploads. And you need to upload ',
  ...
  modelerIn_moreView:
    'Level up your modeling career. Partner with Creality Cloud to spread the word and monetize your models.',
  modelerIn_myfTips:
    'Your created tags will be displayed on your profile in Design Space. Please use them responsibly.',
  ...
  modelerIn_obtToCreateModel:
    'Congrats! You got officially verified. Publish your 3D models now!',
  modelerIn_payPalAccountSettings: 'PayPal Account Settings',
  modelerIn_paypalSetPopDes1:
    'PayPal account setting is for 3D designers to receive payments and cash out. Please become a designer first before setting up your PayPal account. ',
  modelerIn_paypalSetPopDes2:
    "We've rolled out a Designer Partnership Program to build a strong relationship with talented 3D designers. Click to find more details.",
  modelerIn_platformToSign:
  ...
  modelerIn_provideLinkOrPhoto:
    'Please provide a link or photo for your deisgns.',
  ...
  modelerIn_selectTheCategories:
    'Please select the categories of your designs.',
  modelerIn_submit_apply: 'Submit',
  modelerIn_submit_info:
    'Thank you for taking the time to apply to our program. We will process your application within 7 working days.',
  ...
  modelerIn_thanks:
    'Thank you for sharing your designs with the community. We will give you more exposure support according to your model performance.',
  modelerIn_tipsFalse:
  ...
  modelerIn_upNum1:
    ' more models, and you will have a chance to get more exposure.',
  ...
  modeler_content_remark1:
    'Provide dependable technological protection and issued strict licenses (CC license, Standard license) for all original creations. Take immediate action to remove any infringing models.',
  modeler_content_remark2:
    'Access to FREE brand exposure and official promotion in all channels to help increase your popularity.',
  modeler_content_remark3:
    'Gain insights into your sales trends and discover your top-selling models and most profitable sale dates through detailed statistics.',
  modeler_content_remark4:
    'Take full control of your 3D design pricing and customize it to your preference. Create personal discounts to boost sales via your own store.',
  modeler_content_remark5:
    'Create an exclusive 3D model section based on your ideas to share and showcase your 3D designs.',
  modeler_content_remark6:
    'Enjoy a 1-month premium membership service for  FREE to get more access to advanced features and benefits.',
  modeler_content_remark7:
    'Build your business by selling your original 3D designs. You earn <span>100%</span> from every sale! (excluding payment processing fees)',
  modeler_content_remark8:
    'Connect with your peers and gather them on Creality Cloud. Earn additional referral fees for every designer you bring along!',
  modeler_content_remark9:
    'Be a part of the host of 3D print competitions and giveaways. Engage with your community and encourage them to share their creativity to win top prizes.',
  ...
  modeler_help_text:
    'If you have additional questions or need clarification on any part of the program, we encourage you to check our comprehensive Help Hub for guidance.',
  modeler_help_title: 'Help Hub',
  modeler_in_code: 'Invitation Code (optional)',
  modeler_in_code_tips:
    'Code is for Designer Referral Program. Enter if you have it, skip otherwise.',
  ...
  modeler_invite_tips:
    'After the designer friends joined the Designer Partnership Program, you will get the rewards. However, if your friend fails to fill in or fills in the wrong invitation code you sent, you will not be able to get rewards. And this invitation record will not be displayed in the current list.',
  ...
  modeler_withdrawal_tips:
    'It is recommended to cash out a large amount when deducting a PayPal fixed fee.',
  ...
  no_auths_remove_device_tip:
    'The device has been added by other users. Do you want to remove the device?',
  ...
  notWebGlMessage:
    "Your browser currently doesn't support this feature. Please use Chrome 56, Edge 79, Safari 15, Firefox 51, Opera 43, or other higher versions.",
  ...
  original_attentionTip:
    'Please make sure you properly credit the original creator while sharing their works. Creality Cloud respects designers and their hard work, you would take responsibility if a violation of copyrights happens.',
  original_back: 'Back',
  original_cc0:
  ...
  original_commons:
    'In Creality Cloud, your original work (inc 3D prints & articles) is restrictedly protected under Creative Commons Licenses 4.0. If you find any breach of agreement, please contact us to discuss further action.',
  ...
  original_shareTip:
    'Please properly credit the original creators while sharing their works.',
  ...
  payAgreement_st1:
    '1. Punishment for illegal profit by reproducing public free resources',
  payAgreement_st1p:
    'Those who take advantage of free public resources (including all model files and contents in Creality Cloud)  for sale to obtain improper profits, will get a serious warning and be required for an ordered rectification after the misconduct is verified for the first time investigation. If this misbehavior continues, the account will get banned for 7 days in the second time investigation; and banned for 30 days if the misbehavior still continues and is verified for the third time. The balance of the banned account will be frozen leading to unworkable transactions during the period of banning. ',
  payAgreement_st1p2:
  ...
  payAgreement_st3:
    '3. Punishment for illegally reproducing or theft of original design.',
  payAgreement_st3p:
  ...
  payAgreement_st5p:
    '5.1 For those who maliciously make medium or bad reviews after the transaction, Creality Cloud has the right to delete or modify these reviews and give a serious warning.',
  payAgreement_st5p2:
    '5.2 For those who make false reviews that are not related to the fact, Creality Cloud has the right to delete such reviews and comments, and give a serious warning.',
  payAgreement_st5p3:
    '5.3 Those who post the same or similar comment reviews (the following content involved) reached three or more times on the design product selling page and sent these reviews to other users reached three or more times within the platform, will be regarded as a behavior of disorder. Creality Cloud has the right to delete these reviews and give a serious warning or ban the related account for several months according to different situations.',
  payAgreement_st5p3a:
    'A. Comments related to advertisement, propaganda, promotion, canvassing, call, heckling, attack;',
  payAgreement_st5p3b:
    'B. Comments related to pornographic, reactionary, political, violent, bloody content;',
  payAgreement_st5p3c:
    'C. Comments related to malicious insult, abuse, slander, ridicule, and harassment;',
  payAgreement_st5p3d:
    'D. Comments related to endanger national security and divulge state secrets;',
  payAgreement_st5p3e:
    'E. Comments related to infringing upon the legitimate rights and interests of the state, or other individuals;',
  payAgreement_st5p3f:
    'F. Comments related to making, copying, and disseminating illegal and harmful information;',
  payAgreement_st5p3g:
    'G. Comments related to harm the interest of Creality Cloud.',
  payAgreement_st5text:
    'The violation record will be cleared if there is no more violation warning within 180 days from the date of removal of the banning.',
  payAgreement_st5text2:
    'The model published by the same account within 30 days for multiple violations shall be handled in the same batch, and the banning date shall be calculated according to the original banning date plus N days. (N is the number of times of violations).',
  payAgreement_st5text3:
    'Users should conduct a self-examination during the period of banning. If there are illegal resources, please take the initiative to contact us at teamcloud@creality.com to remove them.',
  payAgreement_st5text4:
    'Users who take the initiative to delete the illegal resources during the period of banning can reduce the banning time as appropriate.',
  ...
  payment_orderTimeoutMsg:
    'Your order has timed out. Please back to the order page and pay again.',
  payment_orderTimerStr1: 'Please finish the payment within',
  payment_orderTimerStr2:
    ', or the order will be cancelled automatically for a timeout.',
  payment_payNow: 'Pay Now',
  payment_payTotal: 'Total',
  payment_paymentAlipay: 'Alipay',
  payment_paymentError:
    'Please check the box to show that you have read and agree to the Terms of Payment.',
  payment_paymentWx: 'WeChat Pay',
  payment_payoneer: 'Web Payoneer',
  payment_paypal: 'Paypal',
  payment_qrCodeTimeStr1: 'Remains',
  payment_qrCodeTimeStr2:
    ' to expire. You can get the QR code again after expiration.',
  ...
  photo3d_intoMyorderTips:
    'You can find all lithophanes in Personal Center>Designs>Lithophane Maker.',
  ...
  photo3d_tips:
    'We do not accept returns and refunds for any customized products. Please think twice before you place the order.',
  photo3d_topTips:
    'Free shipping (limited time only). The package contains photos and photo frames, and accessories if selected.',
  photo3d_total: 'Total',
  ...
  planFeatures_buyStorageTip:
    'Choose a storage plan and get more storage for your files and videos.',
  ...
  planFeatures_enjoyMoreEquity:
    'Enjoy the following exclusive features, perks, and more!',
  ...
  planFeatures_expireTip3:
    ' days. Tap on the button below to renew your plan and extend the term of your membership. ',
  ...
  planFeatures_modelDeleteTips:
    'Files cannot be recovered after being deleted! You can set the model as public, which will not take up cloud storage space.',
  ...
  planFeatures_receiveAddTip1:
    'Get Cuvacoins from completing daily missions in ',
  planFeatures_receiveAddTip2: 'Gift Shop. ',
  planFeatures_receiveAddTip3:
    'The more missions you complete, the more cuvacoins you get.',
  planFeatures_receiveTaskTip1:
    'You got Cuvacoins from uploading models mission. Please remember to collect them in',
  ...
  planFeatures_stockagePremiumTip:
    'Enjoy an exclusive discount for getting more storage for your files.',
  ...
  posts_confirmRelateModel:
    'Please confirm that the model you select is the same as the model printed in the current post',
  ...
  priceError_packageMin:
    'The model price can not be lower than the number of your model files.',
  ...
  printParamsText7:
    '. Share the print parameters with other makers to help them make perfect printing results!',
  printPlacehold:
    'You can randomly get Cuvacoin rewards if you write more than 20 characters and upload no less than 3 photos.',
  ...
  printServe_BasicInformation:
    'Your information is on review. Please be patient.',
  ...
  printServe_ByEnablingReceiveOrders:
    'By enabling receive orders, your store will be open to receive 3D printing service orders.',
  ...
  printServe_HollowHint:
    'A model can be hollowed out without affecting the surface of the model, to reduce material consumption and save you time and money. But it may not be stronger enough to be used under high pressure and weight-bearing condition. ',
  ...
  printServe_LCDResin3DPrinter:
    'The maximum printing size of LCD printers (mm)',
  printServe_Later: 'Later',
  printServe_Latest: 'Latest',
  printServe_Live: 'Live',
  printServe_ManagementStore:
    'Everything you need to manage your products is here!',
  printServe_MaterialName: 'Material Name',
  printServe_MaximumDimension:
    'Maximum dimension (At least fill in one  option)',
  ...
  printServe_PleaseOfferModelPrice:
    'Please offer a price for the model to print',
  ...
  printServe_PrintShowcaseTips:
    'You can show photos of your available printers and printing artworks to customers.',
  printServe_PrintShowcaseTips1:
    'Note: Square size images are recommended for a superior visual effect.',
  ...
  printServe_SLAResin3DPrinter:
    'The maximum printing size of SLA printers (mm)',
  printServe_SMSNotification: 'SMS Notification',
  printServe_SeeMore: 'See more',
  printServe_SelectDays: 'Select',
  printServe_SolidHint:
    'A solid model means that an object inside is completely filled with filaments, suitable for being used under high pressure and weight-bearing condition. But it will take more material consumption, leading to a higher price.',
  ...
  printServe_UnapproveTip:
    'Your application has not been approved. Please modify your information and submit it again.',
  printServe_Unavailable: 'Unavailable',
  printServe_UnavailableTip1:
    'Your store has been closed by the platform for violating rules. Please contact the ',
  ...
  printServe_WhetherSave:
    'Do you want to save your settings? You can continue setting after saving.',
  ...
  printServe_addColorTip:
    '(You can select only one color, default, or custom.)',
  ...
  printServe_andOrderNum2:
    ' orders waiting for shipping. Please process these orders in time.',
  ...
  printServe_cardBackTips:
    'Upload a picture of your ID card, the side with an image of your portrait.',
  printServe_cardFront: 'National emblem image',
  printServe_cardFrontTips:
    'Upload a picture of your ID card with an image of the national emblem.',
  ...
  printServe_confirmationOrdersNumTips:
    ' orders waiting for confirmation. Please process the orders in time.',
  printServe_consecutiveLoginTip1: '',
  printServe_consecutiveLoginTip2:
    ' more days of consecutive login will get you a free printing service for the first order. See more details.',
  ...
  printServe_crealityBeasDif:
    " Sorry! You don't have enough Credits in your account balance. Please top up Credits before paying for the order.",
  ...
  printServe_deliveryTimeTip:
    'DTS (Days to ship) is calculated from the next day after the customer successfully paid for the order.',
  printServe_deliveryTimeTipTitle: 'Days to ship',
  printServe_downloadTip1:
    "1. We'll send a link via email to download model files. Please enter your email address.",
  printServe_downloadTip2:
    '2. If you can not find the email in the inbox, please check it in spam. if it is still not found, please require to send it again. ',
  printServe_downloadTip3h:
    ' days. Please download the file and print it in time.',
  ...
  printServe_explainTips:
    'To offer a better service for you , please briefly describe your manufacturing requirements or other needs. ',
  printServe_explainTitle: 'Why do you want to be a manufaturer? (Optional)',
  printServe_facilitatorDetail_FDMsize:
    'Maximum dimension of FDM 3D printer(mm)',
  ...
  printServe_facilitatorDetail_afterSaleHint:
    ' Sales exchange and refund are not supported due to the unique nature of printing services. More details in ',
  ...
  printServe_facilitatorDetail_lineSize:
    'Maximum dimension of Resin 3D printer(mm)',
  ...
  printServe_facilitatorDetail_printHint:
    '* The final price of the order shall be subject to the price provided by the manufacturer.',
  ...
  printServe_facilitatorDetail_slaSize:
    'The maximum printing size of SLA printers(mm)',
  ...
  printServe_freightRule:
    'Shipping fee = First weight + exceeding weight * additional weight fee',
  printServe_freightTip:
    'The shipping fee is regular and for reference only. You need to confirm the final fee with the courier.',
  printServe_gettingOrderTips:
    'Before getting an order, please read and understand the rules of the 3D printing service, so that you can better satisfy the needs of customers and improve your rating and ranking in the 3D printing service and get more orders.',
  printServe_giveFeedback: 'Give us feedback',
  printServe_gram: 'g',
  printServe_hallTipContent:
    'The 3D program started by customers will be shown in the marketplace. All manufacturers can offer their quotes according to customer requirements. In the meantime, customers can compare prices and print quality to pick out the one to their satisfaction. If the customer does not accept your price and pays for the order, the 3D program will not be shown in the order list.',
  ...
  printServe_homePage_fillFullHint:
    '* A higher infill density means that there is more plastic on the inside of your print, leading to a heavier object. So it will take more price.',
  printServe_homePage_gram: 'g',
  printServe_homePage_hintTitle: 'Creality Cloud 3D Printing Service',
  printServe_homePage_hintmsg:
    'Note: To help you get a quote in a short time, we will find an appropriate manufacturer according to your printing needs after you placed an order. So the final manufacturer to offer price may be different from the one you currently choose.',
  ...
  printServe_homePage_needPays:
    'This is a charged model. You need to pay for the model before adding it.',
  ...
  printServe_homePage_orderRemindHint:
    "At that time, we'll send you an SMS message or push notification. Please pay attention in time.",
  printServe_homePage_orderSuccessHint:
    'We have sent your order to the manufacturer. It may take some time for confirmation, so please be patient. You can check out after the manufacturer provides you with a quote.',
  printServe_homePage_orderSuccessTips:
    'Order Submitted and Wait For Confirmation',
  printServe_homePage_placeCheckedAddress: 'Please add an address',
  printServe_homePage_placeholderRemark:
    '(Optional) Describe your printing setting specifically (such as printing materials, layer height, printing precision, and wall thickness) if needed.',
  ...
  printServe_homePage_priceHint:
    'Listed prices are calculated by the system and for reference only. The actual price of the order shall be subject to the price provided by the manufacturer.',
  ...
  printServe_homePage_selectedLimit:
    'It only supports selecting models from Creality Cloud 3D model library.',
  ...
  printServe_merchantInfo_homeNavDesc1:
    'We gather the most professional manufacturers with experience and skills from all over the world and give you the fastest response to your need.',
  printServe_merchantInfo_homeNavDesc2:
    'Give you the priority to compare prices with different manufacturers and pick out the cost-effective printing service.',
  printServe_merchantInfo_homeNavDesc3:
    'Join our free printing service campaign to enjoy high-quality service without spending a penny.',
  ...
  printServe_merchantInfo_otherMerchant:
    'Manufacturers that meet your printing needs',
  ...
  printServe_modelMsg_batchSettingMsg:
    ' After batch editing, it will take effect on all models~',
  ...
  printServe_modelMsg_deleteConfirm:
    'Are you sure you want to delete this model file?',
  printServe_modelMsg_failReset:
    'There is a problem parsing the file. Please upload the file again.',
  printServe_modelMsg_fillingNoLimit:
    'The infill option is not limited. The manufacturer can decide on the infill method according to the actual situation of the print.',
  ...
  printServe_modelMsg_modelFail:
    'There is a problem parsing the file. The file may be damaged. Please fix the file or upload other files.',
  ...
  printServe_modelMsg_settingConsumableColurDiff:
    'The color of the consumables is the color of the printed product.',
  printServe_modelMsg_settingConsumableDiff:
    'The print speed and print quality may differ from the different filaments.',
  ...
  printServe_orderHasAccepted:
    'This order has been accepted by another manufacturer. ',
  ...
  printServe_orderMsg_beFreeAbout2:
    ' consecutive days during the campaign time (from Nov 10 to Dec 10, 2022). If you keep logging in for ',
  printServe_orderMsg_beFreeAbout3:
    ' more days, you can place a 3D printing service order for free!',
  printServe_orderMsg_cancelAffirm:
    'Are you sure you want to leave without saving?',
  printServe_orderMsg_checkQuotationDetail: 'Price Details',
  printServe_orderMsg_checkWaiveCause: 'Cancel reason',
  printServe_orderMsg_checkedIsClose:
    'Prices offered by other manufacturers will be invalid after your payment. Manufacturers without offering prices will no longer offer you prices.',
  ...
  printServe_orderMsg_commentHint:
    'Thank you for your reviews to help manufacturers improve their service.',
  printServe_orderMsg_commentPerformanceEmpty:
    'Please rate the print result based on the cost.',
  printServe_orderMsg_commentPlaceholder:
    'Share details of your own experience at the print service.',
  ...
  printServe_orderMsg_commentSpeedEmpty:
    'Please rate the response speed when getting a quote.',
  printServe_orderMsg_commentSuccess: 'Published',
  printServe_orderMsg_content01:
    'We are sending your orders to manufacturers that meet your needs. Please wait for the quotation.The manufacturers will offer you a price ',
  printServe_orderMsg_content02: 'within 2 hours.',
  printServe_orderMsg_content03:
    ' Please pay attention to your SMS message and push notifications.You can compare the prices on',
  printServe_orderMsg_content04: '',
  printServe_orderMsg_contentNew01:
    'The manufacturer will give you a quote within ',
  ...
  printServe_orderMsg_deleteOrderConfirm:
  ...
  printServe_orderMsg_freeHintBaseStr:
    'Note: The size and printing method of the model is subject to the 3D-printed object.',
  printServe_orderMsg_freeHintStr1:
    'The special offer for Free Order is about to end after ',
  printServe_orderMsg_freeHintStr2:
    '. Now take the final chance and place your 3D print order.',
  ...
  printServe_orderMsg_outCancel:
    'The review content you edited will not be saved after leaving this page',
  printServe_orderMsg_paySuccessHint:
    'Thank you for your payment. The manufacturer will start your print.',
  ...
  printServe_orderMsg_quotationMerchant:
    'Manufacturers are offering their quotes.',
  ...
  printServe_orderMsg_researMerchant:
    "Tell us why you didn't choose these manufacturers.",
  printServe_orderMsg_researchCancelReason: '',
  printServe_orderMsg_researchReasonEmpty: 'Please fill in other reasons.',
  printServe_orderMsg_researchReasonPlaceholder:
    'Please fill in other reasons.',
  ...
  printServe_orderMsg_submitSuccessResearchHint:
    "We're thrilled to hear everything. With the help of your feedback, we'll always be improving.",
  ...
  printServe_orderPaySucc:
    "You've successfully paid for the order! Thank you for your purchase.",
  printServe_orderSetPriceCancel:
  ...
  printServe_otherRansonPla:
    'Please give a reason for cancellation. (Optional)',
  ...
  printServe_pleaseDescribe:
    'Tell the customer about the price list and service you charge.',
  printServe_pleaseEnterDays: 'Numbers of days',
  printServe_pleaseUploadPhotos3DMakes:
    'Please upload photos for your 3D makes.',
  ...
  printServe_providingMoreSpecific:
  ...
  printServe_quoteDetailsPlaceholder:
    '(Required) Please describe detailed information about your quote for your customers, such as the model weight, the supports added, and the unit price of the material you use to print. It will help your customer understand the offer details and place more orders.',
  ...
  printServe_repServiceList10:
    'The Manufacturer wants me to receive the print while I did not',
  ...
  printServe_repServiceList5:
    'The Manufacturer refuses to fulfill the commitment',
  printServe_repServiceList6: 'Poor print quality ',
  printServe_repServiceList7:
    'The Manufacturer harassed/intimidated/threatened me',
  ...
  printServe_sendEmailTip:
    'The download link has been sent to your email address.',
  ...
  printServe_serviceClosePrintServiceTips:
    'From December 30, 2022, the platform will close functions related to printing services. Except for historical orders and accumulated earnings, which will be kept for 2 months for viewing, other related functions are no longer supported.',
  ...
  printServe_shippingOrdersNumTips:
    ' orders waiting for shipping. Please process the orders in time.',
  ...
  printServe_sysCancelReason1:
    'The Order has been cancelled automatically because the Customer did not pay within 24 hours.',
  printServe_sysCancelReason2:
    'The order has been cancelled automatically for being unconfirmed within 48 hours by the Manufacturer.',
  ...
  printServe_toShipTips:
    'DTS (Days to ship) is calculated from the next day after the customer successfully pays for the order.',
  ...
  printServe_uploadCardTips:
    'Please upload a valid image of your ID card. Make sure that the card is complete, clear, and has no reflection. Blocking text and graphics is not allowed.',
  printServe_userClosePrintServiceTips:
    'From December 30, 2022, the platform will close functions related to printing services, and users will no longer be able to place orders.',
  ...
  printServe_userReason4:
    'The manufacturer did not confirm my order for a long time.',
  ...
  printServe_userReason7:
    'The manufacturer wants me to place the order on other platforms',
  ...
  printServe_validateIdCardtipBack:
    'Please upload a picture side of the portrait of your ID card.',
  printServe_validateIdCardtipFront:
    'Please upload a picture side of the national emblem of your ID card.',
  ...
  printServe_validateSize:
    'You need to fill in at least one maximum dimension to print.',
  ...
  printServe_youClosedTip:
    "You can't check orders in the marketplace because you have closed your store. If you want to open your store, please turn on the notification of receiving orders.",
  printServe_youGotPlaceOrder:
    'You got a chance to place your first 3D printing service order for free within 7 days. Place your free order now!',
  ...
  print_addDeviceTip:
    'Scan the QR code to <em>download the Creality Cloud app.</em><br/> If you already have the app installed on your phone, please <em>open it</em> and add your device.',
  ...
  print_aiSettingTip1:
    'By turning this on, the server will analyze the pictures sent from the camera. The AI detection will send you a message when there is a print failure (',
  print_aiSettingTip2: 'click to see examples',
  print_aiSettingTip3: ').',
  print_aliTipsDownload1:
    'Please upgrade the device firmware on the app to version <em>V3.00b70</em> or above',
  ...
  print_autoRecordVideoTips:
    "By turning this on, the device's TF card will save the video when the print starts. Video recording automatically pause when the print stop. Turning on auto-record video may shorten the service life of the TF card and affect printing.",
  ...
  print_beginPrintTip3:
    'remaining on the build plate, otherwise it may cause irreparable damage to the device after start printing.',
  print_beta: 'Beta',
  ...
  print_buyTips:
    'No camera yet? Click the link below to enter the official store',
  print_cameraNotSupported: 'Camera Not Supported',
  print_cameraNotSupported1: 'Camera Not Supported',
  print_cannotTerminate:
    'The printer is heating up. Cannot terminate printing. ',
  print_checkTheTFcard:
    'Please check whether the TF card has been inserted into the device.',
  ...
  print_clearTF: 'Clear',
  print_clearVideoTip:
    'Including videos and time-lapse. It will not affect the normal use after clearing.',
  print_close: 'Off',
  print_closeBed: 'Turn off the hotbed',
  print_connectDeviceTip:
    'Please check if the printer and the box are properly connected',
  print_consumableUse: 'Filament Used：',
  print_continuePrint: 'Continue',
  print_courseTip:
    'Follow the tutorials below to transmit the key file to Raspberry Pi.',
  print_curSeep: 'Speed',
  print_curr: 'Current',
  ...
  print_delayDesc:
    'After connecting the camera to the printer, you can remotely monitor the print status at any time and check the video to playback the whole print process. You can share the time-lapse videos on social media.',
  print_delayTitle:
    'You can also generate time-lapse photography, which is very novel and interesting, to experience',
  print_deleteFileTip: 'Are you sure you want to delete this file?',
  print_detectionSettings: 'Detection Settings',
  print_deviceErrorNeedUpgradePopTip:
    'The device is abnormal. Please upgrade the device firmware to the latest version.',
  print_deviceErrorNeedUpgradeTip1:
    'The device is abnormal. Please upgrade the device firmware to the latest version.',
  ...
  print_deviceOfflineTip:
    'The device is offline. Please connect the device again.',
  print_deviceOwnerCanUpload:
    'Only the device owner can upgrade the firmware. Please get in touch with the owner if there is a need for a firmware upgrade.',
  print_devicePrint: 'Print',
  print_devicePrint1: 'Device',
  print_devicer: 'Admin',
  print_downBedTips:
    'The hotbed temperature are back to normal. Are you sure you want to keep turn off the hotbed ?',
  print_downTemp: 'Cool down',
  print_downTempTips:
    'The nozzle temperature and hotbed temperature are back to normal. Are you sure you want to keep cooling down the temperature ?',
  print_downing: 'Downloading firmware',
  print_downloadBtn: 'Download Key File',
  print_downloadTip:
    'Download the key file to your computer by clicking the following button 【Download Key File】.',
  ...
  print_errDeviceTip:
    'The Printer did not match with the current device type. Printing Failure',
  ...
  print_gcodeClearTip:
    'Including G-code files. It will not affect the normal use after clearing.',
  ...
  print_longTimeTips:
    'Since there is no operation on the page for a long time, please refresh the page to get the latest data',
  ...
  print_noPrinter:
    'Printer not connected!  You can connect it manually on Octoprint',
  print_noTFCardTip: 'Unable to print! No TF card detected.',
  print_noVideoAuth:
    'Currently do not have permission to view video surveillance',
  ...
  print_offlineTip:
    'The device is offline. Please check the device status in App.',
  print_onceSet: 'Range',
  print_online: 'Online',
  print_open: 'On',
  ...
  print_pleaseEnsureTip:
    'Please ensure that the sliced file matches the printer type, or it may cause a print failure. Are you sure you want to start printing?',
  print_pleaseFileName: 'Please name the file.',
  print_pleaseUseApp:
    'It is not supported to use the feature on the website. You can use this feature in the Creality Cloud app.',
  print_position: 'Axis',
  print_positionTips:
    'Please watch your printer when adjusting the moving axis in case of any irreparable damage occurs.',
  print_powerOffRestartTip:
    'The device is powered on. Please confirm whether the printing continues on Sonic Pad.',
  ...
  print_printerPowerConfirmPrint:
    'The printer is power on. Please confirm whether to continue printing.',
  ...
  print_reDownloadTip:
    'Note: If you get a prompt saying that the key file is invalid when installing the device, please click the button to download again.',
  ...
  print_removeNozzleTips:
    "By turning this on, the camera won't show up during the time-lapse shooting, bringing a better video effect. However, it may affect the print quality and cost more time to print.",
  print_rename: 'Rename',
  ...
  print_sonicPadDonotSupportCamera:
    'Sonic Pad do not support camera connection for now.',
  print_state: 'Status',
  ...
  print_stopNowDesc:
    'It may terminate the print job and disconnect the Sonic Screen from the Printer. Are you sure you want to stop?',
  ...
  print_tfFormattingTip:
    'Are you sure you want to format the TF card? All data on the card will be deleted after formatting.',
  print_timeLapseVideoSwitch: 'Time-lapse Video',
  print_timeLapseVideoSwitchTips:
    'By turning this off, the time-lapse video will not automatically be generated after the print is finished. ',
  print_timelapseSettings: 'Time-lapse Settings',
  print_titleTips:
    'If the app shows that the device is online but the web page shows that the device is offline, please upgrade the device firmware on the app. After the upgrade is successful, follow the steps for adding a device to re-configure the device.',
  ...
  print_uploadtoCloudTip:
    'By turning this on, the generated time-lapse video will be automatically uploaded to the cloud and take up your cloud storage. You can find the video in Personal Center> Print>Time-Lapses.',
  print_uplvlBtn: 'Update Now',
  print_useDefaultParam:
    'Failed to set printer parameters, you can reset or print directly with default parameters.',
  ...
  print_wantToResetTheAxis:
    'The axis is not at the home position. Do you want to reset the axis?',
  print_webrtc: 'Camera',
  ...
  productSummary_accessoryTips:
    'Replacement part and maintenance for 3D printers',
  ...
  productSummary_addOnsDesc:
    'Creality 3D printers without built-in Wi-Fi can be connected and remotely controlled through the following external terminal device.',
  ...
  productSummary_contentTips:
    'The related videos, tutorials, and FAQs of this product are here!',
  ...
  productSummary_filterTips1:
    'The following 3D models have been test printed by Creality Cloud users using ',
  productSummary_filterTips3:
    ' Die folgenden Print Files wurden von Creality Cloud-Benutzern testweise gedruckt',
  productSummary_filterTips2: ' .',
  productSummary_guidePrice: 'RRP: ',
  productSummary_guidePriceDesc:
    'The recommended retail price (RRP) is the price suggested by the manufacturer that the product should be sold at and is for reference only. The specific price may vary due to different sales channels. Please refer to the final  price on each sales channel.',
  ...
  productSummary_value1:
    'You can compare printers on the product list page or choose a printer on this page and put it in the comparison chart.',
  productSummary_value2:
    'Choose and put printers (at most 4 printers) in the comparison chart at the same time.',
  productSummary_value3:
    "In the chart, you can replace or delete the printer if you don't need it.",
  ...
  push_msg_1:
    "We'd like to show you notifications for the latest news and updates on Creality Cloud.",
  ...
  reportFrom_descPlaceholder:
    'Fill in relevant information so that we can make a decision as quickly as possible.',
  ...
  search_groupTips1:
    'Make sure everything is spelled correctly or try different keywords. You can explore groups ',
  ...
  search_user: 'Users',
  searching: 'Searching...',
  secondPhase_bigModel:
    'Slicing or previewing of files larger than 200M is not supported.',
  ...
  secondPhase_introduction:
    'Please enter 400 characters or less of personal information',
  ...
  secondPhase_uploadModelTips1:
    'Removed files with incorrect format / larger than ',
  secondPhase_uploadModelTips2: 'M.',
  secondPhase_viewMore: 'Unfold',
  self_check_in_progress_tip:
    'Self-check in progress, please do not operate the printer.',
  serviceAgreement_p: '',
  serviceAgreement_p1:
    'As used in this Section, the term “Platform” means Creality Cloud, the term “Company” means Shenzhen Creality 3D Technology Co., Ltd, and the term “Users” means users of the services. The Platform provides a service that allows users to purchase credit (“CREDIT”), a virtual currency that can be used to pay for printing services, model download, and can be given as a reward to the articles or posts you like. CREDIT balance funds do not constitute a personal property right and have no value outside the Platform. All Users shall use the Platform in accordance with these terms and conditions. Users may not use the Services unless they agree to these terms and conditions. By purchasing from the Platform, Users agree that they will receive CREDIT in exchange for payment of a fee under the terms and conditions laid down in this Agreement.',
  serviceAgreement_p10:
    '1.7 Payment services on the Platform are provided by third-party issuers who may collect your personal information and bank account detail to conduct transactions. Such third parties shall bear any and all responsibility regarding such services or Contents. Furthermore, there may be terms or use or other terms and conditions provided by such third party which are applicable to such services and Contents.',
  serviceAgreement_p11: '<b>2. Disclaimers</b>',
  serviceAgreement_p12:
    '2.1 The Platform sets relevant restrictions and reminders related to transactions from time to time based on considerations of transaction security, operational strategies, etc., including but not limited to transaction limits, number of transactions, etc.',
  serviceAgreement_p13:
    "2.2 If the purchasing process involves related services provided by a third party, in addition to complying with the provisions of this Agreement, you also need to agree to and abide by the third party's Agreement and related rules. In any case, for the third party and its provision, disputes arising from related services of the Company shall be resolved by you and the third party. The Platform does not need to bear any responsibility to you or the third party.",
  serviceAgreement_p14:
    '2.3 The Platform shall not be responsible for being unable to provide CREDIT purchase service in case of the occurrence of any of the following:',
  serviceAgreement_p15: '1) Your account is invalid, lost, or suspended;',
  serviceAgreement_p16:
    '2) Third-party payment method issuers refuse to provide service to you;',
  serviceAgreement_p17:
    '3) Property loss caused by leaking password on purpose;',
  serviceAgreement_p18:
    '4) Property loss caused by your intention or negligence.',
  serviceAgreement_p19:
    '2.4 When you are unable to purchase CREDIT or lose any of your virtual property, you agree that the Platform will not bear any liability for compensation in case of the occurrence of any of the following:',
  serviceAgreement_p2:
  ...
  serviceAgreement_p20:
    '1) Server maintenance period announced on the Platform;',
  serviceAgreement_p21:
    '2) Data transmission cannot be carried out due to failure of telecommunications or equipment;',
  serviceAgreement_p22:
    '3) Certain exceptional cases or in unavoidable circumstances such as typhoons, earthquakes, tsunamis, floods, power outages, wars, terrorist attacks, government control and other force majeure;',
  serviceAgreement_p23:
    '4) Service interruption or delay caused by cyber-attacks, technical adjustments or malfunctions of the telecommunications sector, system upgrades, and related third-party issues.',
  serviceAgreement_p24:
    '2.5 You guarantee that the funds used for the purchase of CREDIT are all your legal income, and you have full rights to use it in accordance with this Agreement. Any disputes arising from your violation of this Agreement shall be handled and resolved by you, and you shall bear all the responsibilities and legal consequences arising therefrom. When the Platform detects that your activity has ran counter to the law, the Platform reserves the right to terminate the provision of services to you and escalate the case to the authorities and prosecute the person at their competent judicial body.',
  serviceAgreement_p25:
    '2.6 Under no circumstances will the Platform be liable for any indirect, consequential, punitive, incidental, special or penal damage. The entire responsibility of the Platform to you, regardless of the reason or behaviour, will never exceed the cost you paid when using the service provided by the Platform.',
  serviceAgreement_p26: '3. <b>Restricted Matters</b>',
  serviceAgreement_p27:
    '3.1 The Platform has the right to suspend or terminate the provision of the services under this Agreement to you at any time without prior notice and does not need to be responsible for the interruption or termination of the service in the event of any of the following situations,',
  ...
  serviceAgreement_p30:
    '3) Acts of using the CREDIT for purposes other than as intended by the CREDIT.',
  serviceAgreement_p31:
    '3.2 Users shall use the service at their own risk and shall bear any and all responsibilities for actions carried out under and the results from the use of the service.',
  serviceAgreement_p32: '4. <b>Miscellaneous</b>',
  serviceAgreement_p33:
  ...
  serviceAgreement_p8:
    '1.5 If any error occurred during the purchase due to a system failure, the Platform reserves the right to correct the error. The Platform reserves the right to amend the CREDIT balance of a user’s account to the correct value, regardless of whether the amount of CREDIT a user received is greater than or less than the amount he has purchased.',
  serviceAgreement_p9:
    '1.6 The Platform will collect information related to Users’ status of use of the services such as their CREDIT balance and orders of CREDIT, printing service, and 3D model files, etc. The Platform will collect the above information in providing services.',
  ...
  service_feed_tip:
    'For expedited resolution, kindly provide a comprehensive description of your issue. This will greatly assist us in swiftly identifying and addressing the problem.',
  ...
  setPayPassword_setPayPasdWarn:
    "*The password you're setting is used for authorizing your withdrawal and payment.",
  setPayPassword_sucessTip: 'Successfully withdrawn to your PayPal account.',
  setPayPassword_verfiyTip:
    'Please bind a phone number or email address to secure your account before setting your payment password.',
  setPayPassword_verfiyWarn1:
    '1. To help keep your account secure, we need to further verify your account. ',
  setPayPassword_verfiyWarn2:
    '2. If your phone number cannot be used for verification, please contact the online service.',
  setPayPassword_verfiyWarn3:
    '2. If your email address cannot be used for verification, please contact the online service.',
  set_discounts_add_model: 'Add 3D Model',
  set_discounts_add_model_err:
    'This model is already in the discounted model list. Please do not add it again.',
  ...
  set_discounts_change_error:
    'The price of the following models is less than 1 Credit. Please set the discount separately in the chart.',
  set_discounts_change_into:
    'Please enter a number greater than 0 and less than 100. When the price is not an integer, it will be calculated according to the rounding rule.',
  ...
  set_discounts_change_msg6:
    'The end time cannot exceed the start time by half a year',
  ...
  set_pay_password_bind_email_title:
    'Please bind email address to secure your account before setting your payment password.',
  shareTips:
    'Share your 3D printing experience and <span> post your 3D makes </span>. Get a chance to win Cuvacoins.',
  siteChina: 'China(+86)',
  siteInt: 'International',
  siteconfig_text1:
    'You have successfully changed your country or region from ',
  siteconfig_text2: 'to ',
  siteconfig_text3:
    'To apply these changes, please log in with your Chinese Creality Cloud account.',
  siteconfig_text4: 'OK',
  siteconfig_text6:
    'You have successfully changed your country or region from ',
  siteconfig_text7:
    ' To apply these changes, please log in with your International Creality Cloud account.',
  ...
  sliceSettings_acceleration_travel_layer_0:
  ...
  sliceSettings_addMyDeviceLimit2:
    " printers. Remove printers you don't need before adding new ones.",
  sliceSettings_addMyDeviceTip: 'Add to "My Printers".',
  sliceSettings_addParamsSuccTip:
    'Successfully saved! Please check the "Profile".',
  sliceSettings_addParmasDialogTitle: 'Name Profile',
  sliceSettings_addParmasPlaceholder:
    'Please enter a parameter profile name within 50 characters.',
  sliceSettings_addSliceLimit:
    'You have reached the limit of saving parameter profiles. Please remove the profiles you don’t need before saving.',
  ...
  sliceSettings_bigSmall:
    'Some of the model sizes are detected as too large or too small. Do you want to adjust them to fit the size?',
  ...
  sliceSettings_changeSliceTip2:
    'Would you like to keep these changed settings after switching profiles?',
  sliceSettings_changeSliceTip3:
    'Alternatively, you can discard the changes to load the default from ',
  ...
  sliceSettings_customDesc:
    'You can add your Non-Creality printers or modified printers here.',
  sliceSettings_customDeviceTip:
    'If you cannot find your printer in the provided list, <a>you have the option to add a custom printer.</a>',
  ...
  sliceSettings_deleteTip:
    'Are you sure to delete this parameter profile? You cannot recover the profile after deletion.',
  sliceSettings_deleteTip1: 'Are you sure to delete the selected ',
  sliceSettings_deleteTip2:
    ' parameter profiles? You cannot recover these profiles after deletion.',
  sliceSettings_depth: 'Penetration',
  sliceSettings_deviceDel: 'Unavailable',
  sliceSettings_deviceDelContent:
    'The printer is unavailable. Do you want to manage your printers?',
  sliceSettings_deviceDelOkText: 'Manage',
  sliceSettings_deviceDelTitle: 'The printer is unavailable.',
  sliceSettings_deviceName: 'Name',
  sliceSettings_deviceNameMax:
    'Please enter a device name under 30 characters.',
  ...
  sliceSettings_drillFailed:
    'Fail to generate holes. Please increase the penetration of the holes or choose "Only drill one layer".',
  ...
  sliceSettings_exitSaveTip:
    'The profile you choose has been modified. Do you want to save it as a new profile?',
  ...
  sliceSettings_ironingTip:
    'When on, the top surface of the printed model is smoother.',
  ...
  sliceSettings_longTouchTips:
    'Rotate the model view with right-click and drag.',
  ...
  sliceSettings_materialNameTip:
    'Please enter a filament name under 10 characters.',
  sliceSettings_max: 'Maximum',
  sliceSettings_min: 'Minimum',
  sliceSettings_modelHidden:
    'The model was hidden. You can choose it again in model list.',
  ...
  sliceSettings_mutilModelsScale:
    'You cannot adjust the dimension when placing multiple models.',
  sliceSettings_myDeives: 'My Printers',
  sliceSettings_myDeivesTip:
    'You can add the printers you frequently use to [My Printers].',
  ...
  sliceSettings_newFeatureStep1:
    'Listed several tools in the toolbar for single model or multiple model editing. ',
  sliceSettings_newFeatureStep2:
    'Now you can check the loading status of the model in the model list and click the file to show or hide models.',
  ...
  sliceSettings_notMatch:
    'The selected slicing file and printer model type do not match',
  ...
  sliceSettings_outPlaneBj:
    'A model outside the print area was detected. Please adjust the model position. ',
  sliceSettings_outPlaneDelete:
    'Some model files are outside the print area. Do you want to exclude these files from slicing?',
  ...
  sliceSettings_platMian:
    'This is the best view for you to set the place on face feature. You can click anywhere on the model to adjust its orientation.',
  ...
  sliceSettings_resetAlert:
    "Are you sure to reset the transformation to it's initial state?",
  ...
  sliceSettings_resetModels:
    'Are you sure to restore all models to their initial state?',
  sliceSettings_resetModelsSuccess:
    'All models have been reset to their initial state.',
  ...
  sliceSettings_saveMyDeviceTip:
    'Please delete the unavailable printers before saving.',
  ...
  sliceSettings_screenTip:
    'You cannot choose both resin printer and filament at the same time.',
  ...
  sliceSettings_setNameTip:
    'Please enter a parameter profile name within 50 characters.',
  sliceSettings_setParmasTip:
    'Parameter profile modified. Save it for easy slicing.',
  sliceSettings_setSupportTip:
    'The red part of the model needs to add supports.',
  sliceSettings_shape: 'Shape',
  sliceSettings_shell: 'Shell',
  sliceSettings_shellFailed:
    'Hollow failed. The model size and the thickness have a significant impact on the success of hollowing out models.',
  sliceSettings_shellSizeLimit:
    'The thickness of hollowing can not be less than 1mm.',
  ...
  sliceSettings_sliceParamsChangeTip:
    'Parameter profile modified. Save the new profile immediately for the next slicing.',
  ...
  sliceSettings_supportOutTip:
    'The model size will be larger than the maximum printing size of the printer after adding supports. Please re-adjust the model size.',
  ...
  sliceSettings_unavailable:
    'printer is unavailable. Please choose another profile.',
  ...
  sliceSettings_vaseTip:
    'NB: Vase Mode only support printing round/arcs models with a single layer of wall thickness.',
  ...
  sliceSettings_xyOffsetTip:
    'Note: The XY Compensation is not enabled when the value comes to 0',
  ...
  sliceSettings_zOffsetTip:
    'Note: The Z Compensation is not enabled when the value comes to 0',
  sliceToken: 'User information not recognised, please log in again',
  sonic_screen_not_video_ver_content:
    'Please upgrade the Sonic Pad firmware to the latest version.',
  sonic_screen_not_video_ver_title:
    'This firmware version does not support the camera connection.',
  speedChance_text0: 'You got ',
  speedChance_text1:
    ' chance(s) of [faster download speed]. Do you want to speed up the 3D model download process?',
  ...
  squareMsg_coverSubTxt:
    'Adding suitable cover images to the article helps to gain more exposure.',
  ...
  squareMsg_sizeHint:
    'It is recommended to upload a cover image with a size larger than 702*394, but not smaller than 375*375',
  ...
  sure_to_device_self_check:
    'Are you sure you want to initiate device self-check?',
  tags_black_word_tip:
    'This tag has been blacklisted and cannot be used for creation.',
  ...
  task_done_toast_text_10_2:
    "Choose a Makers'Tool design to complete missions!",
  ...
  task_done_toast_text_5:
    'Thank you for your feedback. We will reward you after the problem has been confirmed.',
  task_done_toast_text_6:
    'Successfully created! We will reward you after review.',
  ...
  tf_error_manager_dialog:
    "We've detected that your TF card appears to be malfunctioning. We suggest you format and restore the TF card. <span>Please note that all data stored on the card will be permanently erased due to the formatting process. </span> Are you sure you want to format it?",
  tip: 'Tip',
  tips_icon_add_file: 'Add Files ',
  tips_icon_add_file_text:
    'Upload your design concept, slice parameter, and assembly instruction  in ".pdf", "xls", ".docx", ".txt" and other file formats here!',
  ...
  tools_headSlgContent:
    "To order a custom 3D printed Makers' Tool gift, please contact us via phone at +86 400-6133 882 or email us at teamcloud@creality.com.",
  ...
  topicList_d:
    'Selected collections of high-quality 3D printable files for 3D printing and 3D modeling.',
  topicList_k:
    'stl files, 3d models, 3D print, 3D printing, downloadable files, 3d model, free 3d model, 3d print model, 3d model free',
  topicListH1: 'Best 3D Model Collections for 3D Printing',
  topicListH1Desc:
    'We selected high-quality STL files from talented 3D creators. You can find and download STL files from determined 3D model collections, such as Pokemon 3D models, lithophane 3D print files, pen holder 3D models, etc.',
  ...
  tsite_bio:
    'Your Creality Cloud profile URL was not found in Thingiverse profile bio.',
  ...
  tsite_copyLink: 'Copy',
  tsite_copyright:
    'Copyright alert: Please make sure to key in your own username. We expressly distance ourselves from all content imported by our users.',
  tsite_copyrightWarn:
    'Please click on the checkbox and it indicates that you have read the instructions.',
  tsite_delete: 'Delete',
  tsite_deleteSuccess: 'Delete success!',
  tsite_empty:
    "Can't find the model to import due to an unavailable network, please try again later...",
  ...
  tsite_format:
    'Usernames may only includes letters, numbers, hyphens, and underscores.',
  ...
  tsite_importTips:
    'The file has not been completely imported due to network problems. Please download it manually from Thingiverse and edit it again in Creality Cloud to complete the missing model file.',
  tsite_importingStatus: 'Importing',
  tsite_loading:
    'Obtaining information about the model, please wait for a minute...',
  ...
  tsite_pay:
    'Unable to import models! The model has been set as charged. You need to download these model files from Thingiverse and upload them manually. ',
  ...
  uer_profile_clip_tips:
    'The cover on your user page may be shown on Creality Cloud website and the app. Please refer to the cropping box to crop your image.',
  uer_profile_clip_tips1:
    'It is recommended to use a picture with pixels no less than 2560*1024. ',
  ...
  uer_profile_modeler:
    "A verified designer is a special recognization verified by Creality Cloud officials. It's a kind of support for 3D designers with exclusive benefits such as free official promotion and a free trial for premium membership, etc.",
  ...
  uploadModel_docText:
    'Supported 15 types of formats, such as .pdf, .txt, .xls, and .doc, etc',
  uploadModel_docText1:
    ' .You can find all the files on the model detail page after uploading. ',
  ...
  uploadModel_haveModel:
    'The model already exists. please do not upload again.',
  uploadModel_haveSlice:
    'The slice already exists. please do not upload again.',
  uploadModel_lack: '',
  ...
  uploadModel_supportTex:
    'Accepted formats for uploading texture maps: obj, ply, dae, and 3mf.',
  uploadModel_supportTex1: ' Details>',
  uploadModel_supportType: 'Accepted formats: ',
  uploadModel_texFileNameLimit:
    'A name for the texture map cannot be longer than 30 characters. Please modify the name and upload the model files and textures again.',
  uploadModel_texLackNum: 'textures missing',
  uploadModel_texRule1:
    'Accepted formats for uploading model files: .stl, .obj, .ply, .off, .3mf, .3ds, .wrl, and .dae.',
  uploadModel_texRule2:
    'Accepted formats for uploading texture maps: obj, ply, dae, and 3mf.',
  ...
  uploadModel_texRule4:
    'Upload a zip file containing model files in .obj format, multiple materials in .mtl format, and multiple texture maps in .png, .jpg formats, etc.',
  uploadModel_texRule5:
    'Upload a zip file containing model files in .ply format, and a texture map in .png, .jpg formats, etc.',
  uploadModel_texRule6:
    'Upload a zip file containing model files in .dae format, and multiple texture maps in .png, .jpg formats, etc.',
  uploadModel_texRule7:
    'Upload a zip file containing model files in .3mf format, and multiple texture maps in .png, .jpg formats, etc.',
  ...
  uploadModel_uploadNum:
    'Up to 100 files can be uploaded at a time. No restrictions on the number of files in a zip.',
  ...
  uploadModel_uploadZipLimit:
    'Only zip upload is supported. Please again a zip file.',
  ...
  upload_not_cloud_storage_space_desc:
    'Your cloud storage space is insufficient for uploading. ',
  upload_not_cloud_storage_space_desc_buy: 'Purchase additional storage',
  upload_slice_not_cloud_storage_space1:
    'The current available cloud storage space is ',
  upload_slice_not_cloud_storage_space2:
    '. When the space is insufficient, slicing files cannot be uploaded. Please clean up or purchase additional storage in a timely manner. ',
  upload_slice_not_cloud_storage_space3:
    '. When the space is insufficient, model files cannot be uploaded. Please clean up or purchase additional storage in a timely manner. ',
  upload_slice_not_cloud_storage_space4:
    '. When the space is insufficient, video files will not be uploaded to the cloud. Please clean up or purchase additional storage in a timely manner. ',
  upload_slice_not_cloud_storage_space_look: 'Go to check.',
  use_incomplete_parsing_text:
    'Using partially sliced files for printing may result in inaccurate display of <em style="color:#ff7200;">printing status, progress, and the absence of filament</em> usage information.',
  use_time: 'Use Time',
  ...
  userInfo_fileTypeError:
    'The uploaded profile picture can only be in JPG, png, jpg format!',
  ...
  userModels_solutionList11:
    'Printing failed due to insufficient storage in the TF card.',
  ...
  userModels_solutionList4:
    'Printing failed because the device server disconnected.',
  userModels_solutionList5:
    'Printing failed due to a disconnection between the printer and box.',
  userModels_solutionList6:
    'Printing failed because slicing file cannot be found.',
  userModels_solutionList7:
    'Printing failed due to failure to increase printer temperature.',
  userModels_solutionList8: 'Printing failed due to a printer power issue.',
  userModels_solutionList9:
    'Printing failed because the printer is not responding.',
  ...
  userModels_uploadGcodeReuse:
    'The slice file exists. Please do not upload it again.',
  ...
  user_commentTip:
    'Your thoughts and experience will give people a shortcut to a successful print.',
  user_createComment: 'Post a Comment',
  user_createPost: 'Post',
  user_created: 'Created',
  user_data_dialog_close: 'Cancel',
  user_data_dialog_content:
    'Upload at least <span>1</span> original model or share <span>5</span>  non-original models under the CC licenses to unlock the statistics features.',
  user_data_dialog_title: 'My Statistics',
  user_deletes: 'Batch Delete',
  user_exchangeContent:
    'We will send you the gift card information within 7-10 business days. Please check your system messages in time.',
  ...
  user_not_cloud_storage_space_desc:
    'Insufficient cloud storage space. You can clean up or purchase additional space in the "Cloud Storage" section to proceed with the operation.',
  ...
  user_profile_d:
    ', 3d printable models designer from Creality Cloud, the all-in-one 3d printing platform',
  user_profile_t: "'s Profile | Creality Cloud",
  user_setPayPalMeAccount: 'Get Paid with PayPal.Me',
  user_setPaypalAccountPopTip1:
    "Enter your personalized PayPal.Me link to get paid.  If you don't have a PayPal account, please create one on ",
  ...
  user_statistics_tip:
    'The data from the previous day will be updated at 8 AM the next morning.',
  ...
  usersafe_bind_acc_tip2:
    '. The phone number is used for receiving shipping messages and payments. Please make sure the number is valid.',
  ...
  usersafe_bind_null_warn:
    'This account is the only way for you to login to Creality Cloud, please bind your cell phone or email address first and then unbind it.',
  ...
  usersafe_bind_ver_ag:
    'To help keep your account secure, we need to further verify your account. ',
  usersafe_bind_ver_ag_kf1: 'If your',
  usersafe_bind_ver_ag_kf2:
    'cannot be used for verification, please contact the online service.',
  ...
  usersafe_reset_succ_text:
    'Your password has been changed successfully! Please log in with the new password.',
  usersafe_route_name1: 'Account Security',
  usersafe_unbind: 'Unlink',
  usersafe_unbind_acc_tip1:
    '1. After you unbind your social account, your Creality Cloud account can still be used and still have the data preserved. You need to log out and back to your Creality Cloud account to verify your account security. If you forgot the password, please reset the password on the login page.',
  ...
  usersafe_verf_warn_email:
    'If your Email Address cannot be used for verification, please contact the online service.',
  usersafe_verf_warn_phone:
    'If your phone number cannot be used for verification, please contact the online service.',
  version_update: 'Version Updates',
  viewMake: 'View Make',
  vipEquity_Acquired: 'You got ',
  vipEquity_activeEndTip:
    "You've completed the check-in calendar. See you next time～",
  ...
  vipEquity_chooseDeviceTips3:
    '  printers. If you want to add more printers, please upgrade your plan to Premium.',
  ...
  vipEquity_openMemberTip:
    'Upgrade to Premium to get at most 12 check-in cards.',
  ...
  vipEquity_repairTitle2:
    'After using the check-in card, your consecutive check-in days will be changed to ',
  ...
  vipEquity_tooLong:
    'You can only recheck in the date of absence with the last 90 days.',
  ...
  vipEquity_vipAddModel1:
    'Upgrade to Premium to slice multiple 3D model groups at a time.',
  vipEquity_vipAddModel2:
    'You can use advanced slicing features for multiple 3D models.',
  ...
  vipEquity_vipChooseDevice3:
    ' printers and distribute print jobs for them at a time.',
  vipEquity_vipSliceTabTips: 'Now you have the priority to slice 3D models.',
  vipEquity_vipSliceTabTips2:
    'Upgrade to Premium and get the priority to slice 3D models.',
  ...
  wear_exceed_tip2:
    ' badges to show to the public. Please cancel the badges shown to the public before choose a new one.',
  wear_manage_btn: 'Manage',
  wear_medal_btn: 'Display',
  wechat: 'WeChat Official Account',
  withdrawalAgreement_child1:
    'a. PayPal supports USD and HKD currency withdrawals. The fixed fee is charged by PayPal as follows: (depending on the currency you choose when cashing out)',
  withdrawalAgreement_child2:
    'b. Payoneer supports USD currency withdrawal without any service fee for now.',
  ...
  withdrawalAgreement_p1:
    'The Cash Out Service (hereinafter referred to as "the service") is a withdrawal fund service between you ((hereinafter referred to as “the user”) and Creality Cloud (hereinafter referred to as "the platform"), helping you convert your virtual currency into cash. The virtual currency hereinafter refers to Credits you purchased or earned from trading 3D models. By using the service, you tick to accept and agree to be bound by these terms and conditions with CREALITY 3D (HK) TECHNOLOGY LIMITED (hereinafter referred to as "the company"). ',
  withdrawalAgreement_p10:
    '3. Your withdrawal application will be processed within 7 business days after submission.',
  withdrawalAgreement_p11:
    '4. We may charge a service fee to make a withdrawal to your PayPal account. The service fees are divided into two parts, which include the platform commission and service fees charged by third-party financial institutions, such as PayPal or Payoneer. Here comes the specific details:',
  withdrawalAgreement_p11_1:
    '4.1 Platform commission: The commission is charged with 10% of your withdrawal amount.',
  withdrawalAgreement_p11_2:
    '4.2 Service fee: The service fee is charged by third-party financial institutions, such as PayPal or Payoneer.',
  withdrawalAgreement_p12:
    'Creality Cloud attaches great importance to the protection of your privacy. Your withdrawal record and account information (such as your PayPal or Payoneer account) will be protected according to the terms of the Privacy Policy.',
  withdrawalAgreement_p13:
  ...
  withdrawalAgreement_p14:
    '3. The headings of all terms in this service are for reading convenience only, have no actual meaning in themselves, and cannot be used as the basis for the interpretation of the meaning of this service.',
  withdrawalAgreement_p15:
    '4. The terms of this service are partially invalid or unenforceable for whatever reason, and the remaining terms are still valid.',
  withdrawalAgreement_p16:
    '5. CREALITY 3D (HK) TECHNOLOGY LIMITED reserves the right to the final interpretation.',
  withdrawalAgreement_p17:
  ...
  withdrawalAgreement_p18:
    '1. These terms shall be interpreted and governed by the laws of Hong Kong, and you are irrevocably subject to the sole jurisdiction of the courts of the Hong Kong Special Administrative Region for any disputes.',
  withdrawalAgreement_p3:
    'The term "cash out" means that you can covert your Credits into cash from your Creality Cloud account balance and withdraw them to your third-party payment account through a proportional discount.     ',
  withdrawalAgreement_p4:
    'At present, Creality Cloud only supports PayPal and Payoneer to cash out your Credits. To prevent any failure or a delay from occurring, please make sure your PayPal or Payoneer account is activated and your account information is correct and valid before submitting a withdrawal request.',
  withdrawalAgreement_p5:
    '1. You are responsible for all losses of a withdrawal failure caused by you, such as a wrong account or password, inactivated account.',
  withdrawalAgreement_p6:
    '2. You agree that Creality Cloud reserves the right to cancel and return the submission that cannot be withdrawn.',
  ...
  withdrawalAgreement_table:
    '<table><thead><tr><th> Currency</th> <th>Fixed Fee </th></tr></thead><tbody><tr><td>HKD</td><td>40.00</td></tr><tr><td>USD</td><td>5.20</td></tr></tbody></table>',
  ...
  withdrawal_bindAccountTips:
    'Please make sure your ${type} account <span class="color">&nbsp;is not restricted</span>&nbsp;and <span class="color">&nbsp;accepts payments.</span>',
  withdrawal_bindAccountTips1:
    'Please make sure your ${type} account is not restricted and accepts payments.',
  ...
  withdrawal_blackText:
    'Sorry, you currently cannot make withdrawals because your account is frozen. Please contact our customer service to unfreeze your account.',
  ...
  withdrawal_daozPriceTip:
    'Your withdrawal request should be processed within 10 business days.',
  withdrawal_dollar: 'USD',
  withdrawal_faqiWithdrawal: 'Started',
  withdrawal_gouxTip:
    'Please tick to agree to the Service before cashing out credits.',
  ...
  withdrawal_placeT:
    "We have found suspicious activities on your account. Please describe the reason why you haven't made any transactions after you top-up Credits.",
  ...
  withdrawal_readRuleText:
    'Please make sure your PayPal account is not restricted and accepts payments.',
  withdrawal_readRuleTip:
    'Please tick to agree to the Service before cashing out credits.',
  ...
  withdrawal_shouXrules2:
    'The service fee is charged with ${rate}% of your withdrawal amount. ',
  ...
  withdrawal_shoukAccounttip:
    'Please make sure your account information is correct and valid. Any incorrect information may cause a failure of your withdrawal.',
  withdrawal_showWithdrawal: 'Details',
  withdrawal_submitWithdrawal: 'Cash Out',
  withdrawal_timeFilter: 'Sort by time',
  withdrawal_unbindWarntip1:
    'You cannot cash out credits to your PayPal account',
  withdrawal_unbindWarntip1Payoneer:
    'You cannot cash out credits to your Payoneer account',
  ...
  print_file_choose_tips1:
    'Please confirm that the selected print record belongs to the [',
  ...
  print_file_all_tips:
    'Clicking on [Print All Files] will generate a print queue and print each file one by one. You can view and control the progress in the [Workbench - Print Tasks - In Progress] list.',
  ...
  print_file_share_tips:
    'Share your print file for other users to directly print.',
  ...
  print_file_post_tips:
    'The platform will review the quality and relevance of submitted content, and low-quality or irrelevant content may be removed.',
  print_add_post_tips:
    'For posts that have not been associated with any models, you can tap the "More" button on the page to establish the association.',
